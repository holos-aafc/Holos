...
namespace H.Core
{
    ...
    public class CoreConstants
    {
        ...
        /// <summary>
        ///     A sensible default for inputs that require a minimum allowable year (i.e. year of tillage change, year of seeding,
        ///     etc.).
        ...
        public static string NotApplicableOutputString =>
            Resources.NotApplicable; // Don't use a '-' character as it confuses when there are negative numbers in a grid cell
