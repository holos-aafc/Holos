...
namespace H.Core.Services.Initialization.Animals
{
    public partial class AnimalInitializationService
    {
        ...
        /// </summary>
        /// <param name="farm">
        ///     Contains the <see cref="ManureDetails.DailyManureMethaneEmissionRate" /> that needs to be
        ...
        public void InitializeDailyManureMethaneEmissionRate(Farm farm)
        {
            if (farm != null)
                foreach (var managementPeriod in farm.GetAllManagementPeriods())
                    InitializeDailyManureMethaneEmissionRate(managementPeriod);
        }
            ...
            if (managementPeriod != null && managementPeriod.ManureDetails != null)
                if (managementPeriod.AnimalType.IsPoultryType() || managementPeriod.AnimalType.IsOtherAnimalType())
                    managementPeriod.ManureDetails.DailyManureMethaneEmissionRate =
                        _poultryAndOtherLivestockDefaultCh4EmissionFactorsProvider.GetDailyManureMethaneEmissionRate(
        ...
        public void InitializeAnnualEntericMethaneEmissionRate(Farm farm)
        {
            if (farm != null)
                foreach (var managementPeriod in farm.GetAllManagementPeriods())
                    InitializeAnnualEntericMethaneEmissionRate(managementPeriod);
        }
            ...
            if (managementPeriod != null && managementPeriod.ManureDetails != null)
                if (managementPeriod.AnimalType.IsSwineType() ||
                    ...
                    managementPeriod.ManureDetails.YearlyEntericMethaneRate =
                        _entericMethaneProvider.GetAnnualEntericMethaneEmissionRate(managementPeriod);
        }
        ...
        public void InitializeMethaneProducingCapacityOfManure(Farm farm)
        {
            if (farm != null)
                foreach (var managementPeriod in farm.GetAllManagementPeriods())
                    InitializeMethaneProducingCapacityOfManure(managementPeriod);
        }
        ...
        {
            if (managementPeriod != null && managementPeriod.ManureDetails != null &&
                managementPeriod.HousingDetails != null)
            {
                ...
                {
                    var capacity =
                        _defaultMethaneProducingCapacityProvider.GetMethaneProducingCapacityOfManure(managementPeriod
                            .AnimalType);
