...
namespace H.Core.Services.Initialization.Crops
{
    public interface ICropInitializationService
    {
        ...
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the <see cref="CropViewItem" />'s that will have their nitrogen
        ///     fixation reinitialized
        /// </param>
        ...
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant data to pass into
        ///     <see cref="Table_51_Herbicide_Energy_Estimates_Provider" />
        /// </param>
        ...
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant data to pass into
        ///     <see cref="Table_50_Fuel_Energy_Estimates_Provider" />
        /// </param>
        /// <param name="viewItem">The <see cref="CropViewItem" /> that will have its values reset with new default values</param>
        ...
        /// <summary>
        ///     Applies the default properties on a crop view item based on Holos defaults and user defaults (if available). Any
        ...
        void InitializeManureApplicationMethod(CropViewItem viewItem,
            ManureApplicationViewItem manureApplicationViewItem,
            List<ManureApplicationTypes> validManureApplicationTypes);

        void InitializeFertilizerApplicationMethod(CropViewItem viewItem,
            FertilizerApplicationViewItem fertilizerApplicationViewItem);

        void InitializeAmountOfBlendedProduct(Farm farm, CropViewItem viewItem,
            FertilizerApplicationViewItem fertilizerApplicationViewItem);
