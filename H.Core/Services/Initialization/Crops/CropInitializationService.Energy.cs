...
namespace H.Core.Services.Initialization.Crops
{
    public partial class CropInitializationService
    {
        ...
        public void InitializeHerbicideEnergy(Farm farm)
        {
            ...
            foreach (var viewItem in viewItems) InitializeHerbicideEnergy(farm, viewItem);
        }
        ...
        public void InitializeHerbicideEnergy(Farm farm, CropViewItem viewItem)
        {
            ...
            if (herbicideEnergyEstimates != null) viewItem.HerbicideEnergy = herbicideEnergyEstimates.HerbicideEstimate;
        }
        ...
        {
            var viewItems = farm.GetAllCropViewItems();
            foreach (var viewItem in viewItems) InitializeFuelEnergy(farm, viewItem);
        }
        ...
        public void InitializeFuelEnergy(Farm farm, CropViewItem viewItem)
        {
            ...
            if (fuelEnergyEstimates != null) viewItem.FuelEnergy = fuelEnergyEstimates.FuelEstimate;
        }
