...
namespace H.Core.Services.Animals
{
    public interface IManagementPeriodService
    {
        ...
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ///     data
        /// </param>
        /// <param name="animalGroup">
        ///     The <see cref="AnimalGroup" /> containing the <see cref="ManagementPeriod" />'s that will be
        ///     configured
        /// </param>
        /// <param name="bindingManagementPeriod">The instance of <see cref="ManagementPeriod" /> that is used for binding</param>
        /// <param name="animalGroupOnPropertyChanged">
        ///     The instance of a <see cref="PropertyChangedEventHandler" /> that monitors
        ///     animal group for property changed
        /// </param>
        ...
        /// <summary>
        ///     Configures the appropriate replacement heifer <see cref="ManagementPeriod" /> for the cow calf
        ...
        /// <summary>
        ///     Configures the appropriate replacement heifer <see cref="ManagementPeriod" /> for the dairy
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate boars <see cref="ManagementPeriod" /> for the farrow to finish
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        ///     animal group for property changed
        /// </param>
        /// <param name="managementPeriodOnPropertyChanged">
        ///     The instance of a <see cref="PropertyChangedEventHandler" /> that
        ///     monitors management period on property changed
        /// </param>
        ...
        /// <summary>
        ///     Configures the appropriate gilts <see cref="ManagementPeriod" /> for the farrow to finish
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate piglets <see cref="ManagementPeriod" /> for the farrow to finish
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate weaned piglets <see cref="ManagementPeriod" />'s for the farrow to finish
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate piglets <see cref="ManagementPeriod" />'s for the farrow to wean
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate gilts <see cref="ManagementPeriod" />'s for the farrow to wean
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate boars <see cref="ManagementPeriod" />'s for the farrow to wean
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate hogs <see cref="ManagementPeriod" />'s for the grower to finish
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate sheep feedlot <see cref="ManagementPeriod" />'s for the sheep feedlot
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate hens <see cref="ManagementPeriod" />'s for the chicken egg production
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate layer <see cref="ManagementPeriod" />'s for the chicken multiplier breeder
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate broiler <see cref="ManagementPeriod" />'s for the chicken multiplier breeder
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate broiler <see cref="ManagementPeriod" />'s for the chicken meat production
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate young toms <see cref="ManagementPeriod" />'s for the turkey multiplier breeder
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate toms <see cref="ManagementPeriod" />'s for the turkey multiplier breeder
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate young turkey hens <see cref="ManagementPeriod" />'s for the turkey multiplier breeder
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate turkey hens <see cref="ManagementPeriod" />'s for the turkey multiplier breeder
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate young toms <see cref="ManagementPeriod" />'s for the turkey meat production
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate young turkey hens <see cref="ManagementPeriod" />'s for the turkey meat production
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate chicks <see cref="ManagementPeriod" />'s for the chicken multiplier hatchery
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        /// <summary>
        ///     Configures the appropriate poults <see cref="ManagementPeriod" />'s for the chicken multiplier hatchery
        ///     <see cref="AnimalGroup" />
        /// </summary>
        /// <param name="farm">
        ///     The <see cref="Farm" /> containing the relevant <see cref="AnimalGroup" /> used to derive relevant
        ...
        List<ManureStateType> GetValidManureStateType(AnimalType animalType, Farm farm,
