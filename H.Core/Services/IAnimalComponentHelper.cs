...
namespace H.Core.Services
{
    ...
    {
        /// <summary>
        ///     Creates a unique name for a <see cref="ManagementPeriod" />. This ensures each new <see cref="ManagementPeriod" />
        ///     created by the user
        ...
        /// <summary>
        ///     Creates a unique name for a <see cref="ManagementPeriod" /> given a set of existing <see cref="ManagementPeriod" />
        ///     s from an <see cref="AnimalGroup" />.
        ...
        /// <summary>
        ///     GUI uses a management period which can span multiple months - but algorithms use single months for calculations.
        ///     Method takes in a <see cref="ManagementPeriod" />
        ///     and returns a collection of objects that represent single months with the total number of days in that month. The
        ///     returned collection of objects are all of the
