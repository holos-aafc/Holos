...
namespace H.Core.Emissions
{
    public class SummationsCalculator
    {
        ...
        public double CalculateDirectNitrousOxideEmissionsFromSoilsToMgGlobalWarming(
            double directNitrousOxideEmissionsFromSoilsKg)
        {
        ...
        public double CalculateIndirectNitrousOxideEmissionsFromSoilsToMgGlobalWarming(
            double indirectNitrousOxideEmissionsFromSoilsKg)
        {
        ...
        public double CalculateCarbonDioxideEmissionsFromSoilsToMgGlobalWarming(
            double carbonDioxideEmissionsFromSoilsKg)
        {
        ...
        ///     Equation 6.3-1
        /// </summary>
        /// <param name="totalCarbonDioxideEmissionsFromTreePlantingsAndShelterbelt">
        ///     Total CO2 emissions from tree
        ///     plantings/shelterbelt (kg CO2 year^-1)
        /// </param>
        /// <returns>CO2 emissions from tree plantings/shelterbelt (Mg CO2 eq year^-1)</returns>
        public double CalculateCarbonDioxideEmissionsFromTreePlantingsAndShelterbeltToMgGlobalWarming(
            double totalCarbonDioxideEmissionsFromTreePlantingsAndShelterbelt)
        {
        ...
        public double CalculateTotalCarbonDioxideEmissionsFromEnergyUseToMgGlobalWarming(
            double totalCarbonDioxideEmissionsFromEnergyUseKg)
        {
        ...
        public double CalculateEntericMethaneEmissionFromLivestockToMgGlobalWarming(
            List<double> totalEntericMethaneEmissionsFromLivestock)
        {
        ...
        /// <returns>Manure CH4 emission from livestock (Mg CO2 eq year^-1)</returns>
        public double CalculateManureMethaneEmissionFromLivestockToMgGlobalWarming(
            List<double> totalManureMethaneEmissionsFromLivestock)
        {
        ...
        ///     Equation 6.7.1-1
        /// </summary>
        /// <param name="totalManureDirectNitrousOxideEmissionsFromLivestock">
        ///     Total manure direct N2O emission from livestock (kg
        ///     N2O year^-1)
        /// </param>
        /// <returns>Manure direct N2O emission from livestock (Mg CO2 eq year^-1)</returns>
        public double CalculateManureDirectNitrousOxideEmissionFromLivestockToMgGlobalWarming(
            IEnumerable<double> totalManureDirectNitrousOxideEmissionsFromLivestock)
        {
        ...
        ///     Equation 6.7.2-1
        /// </summary>
        /// <param name="totalManureIndirectNitrousOxideEmissionsFromLivestock">
        ///     Total manure direct N2O emission from livestock (kg
        ///     N2O year^-1)
        /// </param>
        /// <returns>Manure direct N2O emission from livestock (Mg CO2 eq year^-1)</returns>
        public double CalculateManureIndirectNitrousOxideEmissionFromLivestockToMgGlobalWarming(
            IEnumerable<double> totalManureIndirectNitrousOxideEmissionsFromLivestock)
        {
        ...
        /// <param name="indirectManureNitrousOxideEmissionsFromLivestockMg">
        ///     Manure indirect N2O emission from livestock (Mg CO2 eq
        ///     year^-1)
        /// </param>
        /// <returns>Indirect N2O emissions from farm (Mg CO2 eq year^-1)</returns>
        public double CalculateIndirectNitrousOxideEmissionsFromFarmToMgGlobalWarming(
            double indirectNitrousOxideEmissionsFromSoilsMg,
        ...
        /// <param name="CO2EmissionsFromTreePlantingsAndShelterbeltMg">
        ///     CO2 emissions from tree plantings/shelterbelt (Mg CO2 eq
        ///     year^-1)
        /// </param>
