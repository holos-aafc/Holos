...
{
    /// <summary>
    /// Table 38: This provider reads data from an excel file that is the combination of Table 38 and Table 39
    /// </summary>
    public class EnergyRequirementsForCropsProvider_Table_38
    {
        private List<EnergyRequirementsForCropsData> _data;
        private readonly CropTypeStringConverter _cropTypeStringConverter;

        public EnergyRequirementsForCropsProvider_Table_38()
        {            
        ...
        private List<EnergyRequirementsForCropsData> ReadFile()
        {
            ...
            var result = new List<EnergyRequirementsForCropsData>();
            ...
            for (int row = startingRowIndex; row < filelines.Count; row++)
            {
                ...
                {
                    // Black soil type
                    result.Add(new EnergyRequirementsForCropsData()
                    {
                        CropType = cropType,
                        Province = province,
        ...
        public EnergyRequirementsForCropsData GetEnergyData(Province province,
                                                            ...
                                                            CropType cropType)
        {
            ...
            if (result == null)
            {
                ...
                return new EnergyRequirementsForCropsData()
                {
