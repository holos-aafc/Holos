...
namespace H.Core.Providers.Plants
{
    ...
    public class Duplicate_EnergyRequirementsForCropsProvider
    {
        ...
        private readonly List<Duplicate_EnergyRequirementsForCropsData> _data;
        ...
        private List<Duplicate_EnergyRequirementsForCropsData> ReadFile()
        {
            ...
            for (var row = startingRowIndex; row < filelines.Count; row++)
            {
                var line = filelines.ElementAt(row);
                if (string.IsNullOrWhiteSpace(line[0]) || line[0].Equals("Total tree fruits & nuts",
                ...
                var westernProvinces = new List<Province>
                    { Province.Alberta, Province.Saskatchewan, Province.Manitoba };
                foreach (var province in westernProvinces)
                {
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[19])
                            ? 0
                            : double.Parse(line[19], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[20])
                            ? 0
                            : double.Parse(line[20], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[21])
                            ? 0
                            : double.Parse(line[21], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[22])
                            ? 0
                            : double.Parse(line[22], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[23])
                            ? 0
                            : double.Parse(line[23], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[24])
                            ? 0
                            : double.Parse(line[24], cultureInfo)
                    });
                }

                var easternProvinces = new List<Province>
                {
                    Province.PrinceEdwardIsland, Province.NovaScotia, Province.NewBrunswick, Province.Newfoundland,
                    Province.Ontario, Province.Quebec
                };
                foreach (var province in easternProvinces)
                {
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[25])
                            ? 0
                            : double.Parse(line[25], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[26])
                            ? 0
                            : double.Parse(line[26], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[27])
                            ? 0
                            : double.Parse(line[27], cultureInfo)
                    });
                }
                ...
                foreach (var province in bc)
                {
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[28])
                            ? 0
                            : double.Parse(line[28], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[29])
                            ? 0
                            : double.Parse(line[29], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[30])
                            ? 0
                            : double.Parse(line[30], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[31])
                            ? 0
                            : double.Parse(line[31], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[32])
                            ? 0
                            : double.Parse(line[32], cultureInfo)
                    });
                    ...
                    result.Add(new Duplicate_EnergyRequirementsForCropsData
                    {
                        ...
                        EnergyForHerbicide = string.IsNullOrWhiteSpace(line[33])
                            ? 0
                            : double.Parse(line[33], cultureInfo)
                    });
                }
            }
            ...
            CropType cropType)
        {
            ...
            if (soilFunctionalCategory.IsBlack())
                soilFunctionalCategory = SoilFunctionalCategory.Black;
            else if (soilFunctionalCategory.IsBrown()) soilFunctionalCategory = SoilFunctionalCategory.Brown;

            var result = _data.FirstOrDefault(x =>
            ...
            {
                Trace.TraceError(
                    $"Energy data not found for {province.GetDescription()}, {soilFunctionalCategory.GetDescription()}, {tillageType.GetDescription()}, {cropType.GetDescription()}");
