...
namespace H.Core.Providers.Plants
{
    ...
    /// Table 39
    /// </summary>
    public class CropTypeToDetermineEFuelAndEHerbicideForEasternCanada_Table_39
    {
        private List<CropTypeToDetermineEFuelAndEHerbicideForEasternCanadaTableData> _data;

        public CropTypeToDetermineEFuelAndEHerbicideForEasternCanada_Table_39()
        {
            ...
            _data.Add(new CropTypeToDetermineEFuelAndEHerbicideForEasternCanadaTableData()
            {
                CropType = CropType.HayGrass,
                CropTypeValue = 4
            });

            _data.Add(new CropTypeToDetermineEFuelAndEHerbicideForEasternCanadaTableData()
            {
                CropType = CropType.HayLegume,
                CropTypeValue = 4
            });
