...
{
    /// <summary>
    ///     Table 10. Default values for carbon to nitrogen ratios, nitrogen, and lignin contents in livestock manure for the
    ///     steady-state method (from IPCC (2019), Table 5.5C)
    /// </summary>
    public class Table_10_Default_Values_For_Steady_State_Method_Provider
    {
        ...
        public Table_10_Default_Values_For_Steady_State_Method_Provider()
        {
        ...
        /// <summary>
        ///     Contains all the <see cref="Table_10_Default_Values_For_Steady_State_Method_Data" /> instances from the .csv file.
        /// </summary>
        public List<Table_10_Default_Values_For_Steady_State_Method_Data> DefaultValuesData { get; }
        ...
        /// <returns>
        ///     Returns an instance of <see cref="Table_10_Default_Values_For_Steady_State_Method_Data" /> with values for the
        ///     specified animal type.
        ///     If no data is found, returns null
        /// </returns>
        public Table_10_Default_Values_For_Steady_State_Method_Data GetSteadyStateMethodValueForAnimalGroup(
            AnimalType animalType)
        {
            ...
            if (data == null)
                Trace.TraceError(
                    $"{nameof(Table_10_Default_Values_For_Steady_State_Method_Provider)}.{nameof(GetSteadyStateMethodValueForAnimalGroup)} " +
        ...
        private List<Table_10_Default_Values_For_Steady_State_Method_Data> ReadFile()
        {
            ...
            var fileLines = CsvResourceReader.GetFileLines(CsvResourceNames.SteadyStateMethodDefaultNValues);
            var cultureInfo = InfrastructureConstants.EnglishCultureInfo;

            foreach (var line in fileLines.Skip(1))
            {
                if (string.IsNullOrEmpty(line[0])) break;
                ...
                fileData.Add(new Table_10_Default_Values_For_Steady_State_Method_Data
                {
                    AnimalType = animalType,
