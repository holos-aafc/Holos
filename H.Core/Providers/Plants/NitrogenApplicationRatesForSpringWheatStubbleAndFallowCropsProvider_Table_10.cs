...
{
    public class NitrogenApplicationRatesForSpringWheatStubbleAndFallowCropsProvider_Table_10
    {
        #region Fields
        ...
        #region Constructors
        public NitrogenApplicationRatesForSpringWheatStubbleAndFallowCropsProvider_Table_10()
        {
            _cache = BuildCache();
        }
        #endregion
