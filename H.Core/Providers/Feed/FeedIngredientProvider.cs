...
namespace H.Core.Providers.Feed
{
    ...
    public class FeedIngredientProvider : IFeedIngredientProvider
    {
        ...
        {
            _beefFeedIngredients = ReadBeefFile().ToList();
            _dairyIngredients = ReadDairyFile().ToList();
            _swineFeedIngredients = ReadSwineFile().ToList();

            var feedIngredientMapper = new MapperConfiguration(x => { x.CreateMap<FeedIngredient, FeedIngredient>(); },
            ...
            foreach (var line in fileLines.Skip(1))
            {
                var feedData = new FeedIngredient
                {
                    ...
                    CrudeProtein = double.TryParse(line[6], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    CrudeFiber = double.TryParse(line[7], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    EE = double.TryParse(line[8], NumberStyles.Any, cultureInfo, out parseResult) ? parseResult : 0,
                    AcidEtherExtract = double.TryParse(line[9], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Ash = double.TryParse(line[10], NumberStyles.Any, cultureInfo, out parseResult) ? parseResult : 0,
                    GrossEnergy = double.TryParse(line[11], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    DeSwine = double.TryParse(line[12], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ME =
                    ...
                    Sucrose = double.TryParse(line[16], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Raffinose = double.TryParse(line[17], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Stachyose = double.TryParse(line[18], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Verbascose = double.TryParse(line[19], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Oligosaccharides = double.TryParse(line[20], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Starch =
                        double.TryParse(line[21], NumberStyles.Any, cultureInfo, out parseResult) ? parseResult : 0,
                    ...
                    Hemicellulose = double.TryParse(line[24], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ...
                    CpDigestAID = double.TryParse(line[48], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ArgDigestAID = double.TryParse(line[49], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    HisDigestAID = double.TryParse(line[50], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    IleDigestAID = double.TryParse(line[51], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    LeuDigestAID = double.TryParse(line[52], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    LysDigestAID = double.TryParse(line[53], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    MetDigestAID = double.TryParse(line[54], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    PheDigestAID = double.TryParse(line[55], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ThrDigestAID = double.TryParse(line[56], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    TrpDigestAID = double.TryParse(line[57], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ValDigestAID = double.TryParse(line[58], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    AlaDigestAID = double.TryParse(line[59], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    AspDigestAID = double.TryParse(line[60], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    CysDigestAID = double.TryParse(line[61], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    GluDigestAID = double.TryParse(line[62], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    GlyDigestAID = double.TryParse(line[63], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ProDigestAID = double.TryParse(line[64], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    SerDigestAID = double.TryParse(line[65], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    TyrDigestAID = double.TryParse(line[66], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    CpDigestSID = double.TryParse(line[67], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ArgDigestSID = double.TryParse(line[68], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    HisDigestSID = double.TryParse(line[69], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    IleDigestSID = double.TryParse(line[70], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    LeuDigestSID = double.TryParse(line[71], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    LysDigestSID = double.TryParse(line[72], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    MetDigestSID = double.TryParse(line[73], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    PheDigestSID = double.TryParse(line[74], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ThrDigestSID = double.TryParse(line[75], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    TrpDigestSID = double.TryParse(line[76], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ValDigestSID = double.TryParse(line[77], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    AlaDigestSID = double.TryParse(line[78], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    AspDigestSID = double.TryParse(line[79], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    CysDigestSID = double.TryParse(line[80], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    GluDigestSID = double.TryParse(line[81], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    GlyDigestSID = double.TryParse(line[82], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ProDigestSID = double.TryParse(line[83], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    SerDigestSID = double.TryParse(line[84], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    TyrDigestSID = double.TryParse(line[85], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ...
                    PhytatePhosphorus = double.TryParse(line[100], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ATTDPhosphorus = double.TryParse(line[101], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    STTDPhosphorus = double.TryParse(line[102], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    BetaCarotene = double.TryParse(line[103], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    VitE = double.TryParse(line[104], NumberStyles.Any, cultureInfo, out parseResult) ? parseResult : 0,
                    VitB6 =
                        double.TryParse(line[105], NumberStyles.Any, cultureInfo, out parseResult) ? parseResult : 0,
                    VitB12 = double.TryParse(line[106], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Biotin = double.TryParse(line[107], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Folacin = double.TryParse(line[108], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Niacin = double.TryParse(line[109], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    PantothenicAcid = double.TryParse(line[110], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Riboflavin = double.TryParse(line[111], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Thiamin = double.TryParse(line[112], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    Choline = double.TryParse(line[113], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    EtherExtractDup = double.TryParse(line[114], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
        ...
        private IEnumerable<FeedIngredient> ReadDairyFile()
        {
            ...
            foreach (var line in fileLines.Skip(2))
            {
                ...
                var feedData = new FeedIngredient
                {
                    ...
                    TotalDigestibleNutrient = double.TryParse(line[3], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    DryMatter = double.TryParse(line[4], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    CrudeProtein = double.TryParse(line[5], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    ...
                    Lignin =
                        double.TryParse(line[11], NumberStyles.Any, cultureInfo, out parseResult) ? parseResult : 0,
                    Ash = double.TryParse(line[12], NumberStyles.Any, cultureInfo, out parseResult) ? parseResult : 0,
                    ...
                    NEL_ThreeX = double.TryParse(line[15], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
                    NEL_FourX = double.TryParse(line[16], NumberStyles.Any, cultureInfo, out parseResult)
                        ? parseResult
                        : 0,
