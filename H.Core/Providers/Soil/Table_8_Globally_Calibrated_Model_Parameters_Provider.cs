...
namespace H.Core.Providers.Soil
{
    ...
    public class Table_8_Globally_Calibrated_Model_Parameters_Provider
    {
        ...
        /// <summary>
        /// List of Table_8_Globally_Calibrated_Model_Parameters_Data instances. Each parameter has its own data instance in the list.
        /// </summary>
        List<Table_8_Globally_Calibrated_Model_Parameters_Data> Data { get; set; }
        ...
        /// </summary>
        /// <returns>A list containing instances of Table_8_Globally_Calibrated_Model_Parameters_Data. Each instance is a single line in the csv file</returns>
