...
{
    public class Table_8_Globally_Calibrated_Model_Parameters_Data
    {
        /// <summary>
        ///     Globally calibrated model parameters to be used to estimate soc changes fro mineral soils with tier 2
        ///     steady-state-method
        /// </summary>
