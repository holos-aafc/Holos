...
namespace H.Core.Providers.Energy
{
    ...
    public class Table_49_Electricity_Conversion_Defaults_Provider
    {
        ...
        /// </summary>
        private List<Table_49_Electricity_Conversion_Defaults_Data> Data { get; set; }
        ...
        /// <returns>Returns an instance of Table_49_Electricity_Conversion_Defaults_Data based on the year and province. If nothing found, returns null. 
        ...
        /// <summary>
        /// Reads the electricity conversion file and puts the data from the file into a List of Table_49_Electricity_Conversion_Defaults_Data instances.
        /// </summary>
