...
{
    public class FuelEnergyEstimatesProvider_Table_50
    {
        #region Fields
        ...
        public FuelEnergyEstimatesProvider_Table_50()
        {
        ...
        public FuelEnergyEstimatesData GetFuelEnergyEstimatesDataInstance(Province province, SoilFunctionalCategory soilCategory, TillageType tillageType, CropType cropType)
        {
            ...
            if (data != null)
            {
                Trace.TraceError($"{nameof(FuelEnergyEstimatesProvider_Table_50)}.{nameof(FuelEnergyEstimatesProvider_Table_50.GetFuelEnergyEstimatesDataInstance)}" +
