...
{
    /// <summary>
    /// Table 51. Herbicide energy requirement (Eherbicide) estimates for various crops in different regions of Canada for specific soils and tillage operations1 (GJ ha-1).
    /// </summary>
    public class Table_51_Herbicide_Energy_Estimates_Provider
    {
        ...
        List<Table_51_Herbicide_Energy_Estimates_Data> Data { get; set; }
        ...
        /// <returns> The method returns an instance of Table_51_Herbicide_Energy_Estimates_Data based on the characteristics in the parameters. Returns null if nothing found.
        ///  Unit of measurement of herbicide energy estimates is GJ ha-1</returns>
        public Table_51_Herbicide_Energy_Estimates_Data GetHerbicideEnergyDataInstance(Province provinceName, SoilFunctionalCategory soilCategory, TillageType tillageType, CropType cropType)
        {
        ...
        /// </summary>
        /// <returns>Returns a List of Table_51_Herbicide_Energy_Estimates_Data instances. Each instance presents a single cell and contains properties that represent information regarding that cell.</returns>
