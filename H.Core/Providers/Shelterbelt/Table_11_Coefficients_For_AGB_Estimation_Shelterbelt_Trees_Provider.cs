...
namespace H.Core.Providers.Shelterbelt
{
    ...
    public class Table_11_Coefficients_For_AGB_Estimation_Shelterbelt_Trees_Provider
    {
        ...
        public List<Table_11_Coefficients_For_AGB_Estimation_Shelterbelt_Trees_Data> GetData()
        {
            return _cache;
        }

        private List<Table_11_Coefficients_For_AGB_Estimation_Shelterbelt_Trees_Data> BuildCache()
        {
            ...
            foreach (var line in filelines.Skip(1))
            {
                ...
                var entry = new Table_11_Coefficients_For_AGB_Estimation_Shelterbelt_Trees_Data
                {
