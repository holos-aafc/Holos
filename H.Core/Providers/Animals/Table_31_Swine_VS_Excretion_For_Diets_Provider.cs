...
{
    /// <summary>
    ///     Table 31. Volatile solid excretion for performance standard diets for each pig group, by province.
        ...
        public Dictionary<AnimalType, double> GetByProvince(Province province)
        {
            switch (province)
            {
                ...
                default:
                    ...
                    Trace.TraceError(
                        $"{nameof(Table_31_Swine_VS_Excretion_For_Diets_Provider)}.{nameof(GetByProvince)}" +
