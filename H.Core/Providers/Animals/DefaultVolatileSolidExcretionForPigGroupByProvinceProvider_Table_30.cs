...
{  
    ...
    /// Table 30.
    /// </summary>
    public class DefaultVolatileSolidExcretionForPigGroupByProvinceProvider_Table_30
    {
        #region Constructors
        
        public DefaultVolatileSolidExcretionForPigGroupByProvinceProvider_Table_30()
        {
        ...
        public Dictionary<AnimalType, double> GetByProvince(Province province)
        {
            switch (province)
            {
                ...
                default:
                    ...
                    System.Diagnostics.Trace.TraceError($"{nameof(DefaultVolatileSolidExcretionForPigGroupByProvinceProvider_Table_30)}.{nameof(DefaultVolatileSolidExcretionForPigGroupByProvinceProvider_Table_30.GetByProvince)}" +
