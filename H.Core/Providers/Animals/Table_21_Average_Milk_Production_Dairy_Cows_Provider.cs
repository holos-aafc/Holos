...
namespace H.Core.Providers.Animals
{
    ...
    public class Table_21_Average_Milk_Production_Dairy_Cows_Provider
    {
        ...
        /// <summary>
        /// A list of <see cref="Table_21_Average_Milk_Production_Dairy_Cows_Data"/> where each entry in the list represents a single cell in the provider's csv file.
        /// </summary>
        private List<Table_21_Average_Milk_Production_Dairy_Cows_Data> AvgMilkProductionData { get; set; }
