...
namespace H.Core.Providers.Animals
{
    ...
    /// Table 40
    /// </summary>
    public class NitrogenConcentrationLiquidManureProvider_Table_40
    {
        #region Fields
        ...
        public NitrogenConcentrationLiquidManureProvider_Table_40()
        {
        ...
        public NitrogenConcentrationOfLiquidManureTableData GetData(AnimalType animalType)
        {
            ...
            Trace.TraceError($"{nameof(NitrogenConcentrationLiquidManureProvider_Table_40)}.{nameof(GetData)}: unknow animal type '{animalType}'. Returning default of {defaultData}");
