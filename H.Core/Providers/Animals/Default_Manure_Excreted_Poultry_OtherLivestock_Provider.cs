...
namespace H.Core.Providers.Animals
{
    ...
    /// </summary>
    public class Default_Manure_Excreted_Poultry_OtherLivestock_Provider
    {
        public double GetManureExcretionRate(AnimalType animalType)
        {
            ...
            Trace.TraceError($"{nameof(Default_Manure_Excreted_Poultry_OtherLivestock_Provider)}.{nameof(GetManureExcretionRate)}" +
