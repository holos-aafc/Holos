...
namespace H.Core.Providers.Animals
{
    ...
    {
        /// <summary>
        ///     Set the available options for the user based on the information in the table. If there is no lookup value in the
        ///     table, the manure state type shouldn't be available as
