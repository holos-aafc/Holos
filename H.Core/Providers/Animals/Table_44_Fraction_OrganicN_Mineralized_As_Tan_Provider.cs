...
namespace H.Core.Providers.Animals
{
    ...
    ///     denitrified during solid and liquid manure storage for beef and dairy cattle (based on TAN content) (Chai et al.,
    ///     2014,2016).
    /// </summary>
    public class Table_44_Fraction_OrganicN_Mineralized_As_Tan_Provider
    {
            ...
            double fractionOfTanInLiquidManureStorageSystem = 1)
        {
            ...
            switch (stateType)
            {
                ...
                case ManureStateType.DeepPit:
                    return new FractionOfOrganicNitrogenMineralizedData
                    {
                        ...
                        FractionNitrified = 0.021 / (fractionOfTanInLiquidManureStorageSystem > 0
                            ? fractionOfTanInLiquidManureStorageSystem
                            : 1),
                        FractionDenitrified = 0.021 / (fractionOfTanInLiquidManureStorageSystem > 0
                            ? fractionOfTanInLiquidManureStorageSystem
                            : 1),

                        N2O_N = 0.005 / (fractionOfTanInLiquidManureStorageSystem > 0
                            ? fractionOfTanInLiquidManureStorageSystem
                            : 1),
                        NO_N = 0.0005 / (fractionOfTanInLiquidManureStorageSystem > 0
                            ? fractionOfTanInLiquidManureStorageSystem
                            : 1),
                        N2_N = 0.015 / (fractionOfTanInLiquidManureStorageSystem > 0
                            ? fractionOfTanInLiquidManureStorageSystem
                            : 1),
                        N_Leached = 0
                    };
            ...
            Trace.TraceError(
                $"{nameof(Table_44_Fraction_OrganicN_Mineralized_As_Tan_Provider)}.{nameof(GetByStorageType)} unknown type {stateType.GetDescription()}. Returning default.");
