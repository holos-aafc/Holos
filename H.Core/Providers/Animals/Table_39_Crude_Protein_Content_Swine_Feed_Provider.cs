...
namespace H.Core.Providers.Animals
{
    ...
    public class Table_39_Crude_Protein_Content_Swine_Feed_Provider
    {
        ...
        public double GetCrudeProteinInFeedForSwineGroupByProvince(Province province, DietType dietType)
        {
            ...
            if (byProvince.ContainsKey(dietType)) return byProvince[dietType];

            Trace.TraceError(
                $"{nameof(Table_39_Crude_Protein_Content_Swine_Feed_Provider)}.{nameof(GetCrudeProteinInFeedForSwineGroupByProvince)}" +
