...
{
    public class AverageMilkProductionForDairyCowsProvider
    {
        #region Fields
        ...
        public AverageMilkProductionForDairyCowsProvider()
        {
        ...
        /// <summary>
        /// A list of <see cref="AverageMilkProductionForDairyCowsData"/> where each entry in the list represents a single cell in the provider's csv file.
        /// </summary>
        private List<AverageMilkProductionForDairyCowsData> AvgMilkProductionData { get; set; }
        ...
        public double GetAverageMilkProductionForDairyCowsValue(int year, Province province)
        {
            ...
            if (data != null)
            {
                Trace.TraceError($"{ nameof(AverageMilkProductionForDairyCowsProvider)}.{nameof(AverageMilkProductionForDairyCowsProvider.GetAverageMilkProductionForDairyCowsValue)}" +
        ...
        /// </summary>
        /// <returns>Returns a list containing <see cref="AverageMilkProductionForDairyCowsData"/></returns>
        public List<AverageMilkProductionForDairyCowsData> ReadFile()
        {
            var milkProductionData = new List<AverageMilkProductionForDairyCowsData>();
            ...
            {
                // For each row, go to each column and store the relevant cell as a AverageMilkProductionForDairyCowsData instance in a list.
                foreach (KeyValuePair<Province, int> province in dataLocation)
                {
                    ...
                    milkProductionData.Add(new AverageMilkProductionForDairyCowsData 
                    {
                        Year = year,
