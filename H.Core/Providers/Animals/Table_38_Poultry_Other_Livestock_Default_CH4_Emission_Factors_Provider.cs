...
namespace H.Core.Providers.Animals
{
    ...
    public class Table_38_Poultry_Other_Livestock_Default_CH4_Emission_Factors_Provider
    {
        public double GetDailyManureMethaneEmissionRate(AnimalType animalType)
        {
            ...
            // Footnote 2
            if (animalType.IsTurkeyType()) return 0.00036;

            // Footnote 2
            if (animalType == AnimalType.Ducks) return 0.00010;

            // Footnote 2
            if (animalType == AnimalType.Geese) return 0.00015;

            if (animalType == AnimalType.Llamas || animalType == AnimalType.Alpacas) return 0.000521;

            // Footnote 3
            if (animalType == AnimalType.Deer || animalType == AnimalType.Elk) return 0.000603;
