...
{
    /// <summary>
    /// Table 34. Daily volatile solid excretion factors for chickens, goats, llamas and alpacas, horses, mules and bison.
    /// </summary>
    public class Table_34_Livestock_Daily_Volatile_Excretion_Factors_Provider
    {
        public Table_34_Livestock_Daily_Volatile_Excretion_Factors_Provider()
        {
        }
        ...
        public Table_34_Livestock_Daily_Volatile_Excretion_Factors_Data GetDefaultVolatileSolidExcretionData(AnimalType animalType)
        {
            ...
            if (animalType == AnimalType.ChickenPullets || animalType == AnimalType.ChickenCockerels)
            {
                ...
                return new Table_34_Livestock_Daily_Volatile_Excretion_Factors_Data()
                {
            ...
            Trace.TraceError($"{nameof(Table_34_Livestock_Daily_Volatile_Excretion_Factors_Provider)}.{nameof(GetDefaultVolatileSolidExcretionData)}" +
