...
namespace H.Core.Providers.Animals
{
    ...
    public class Table_34_Livestock_Daily_Volatile_Excretion_Factors_Provider
    {
        ...
        {
            return GetDefaultVolatileSolidExcretionData(animalType).VolatileSolids;
        }

        public Table_34_Livestock_Daily_Volatile_Excretion_Factors_Data GetDefaultVolatileSolidExcretionData(
            AnimalType animalType)
        {
            ...
            Trace.TraceError(
                $"{nameof(Table_34_Livestock_Daily_Volatile_Excretion_Factors_Provider)}.{nameof(GetDefaultVolatileSolidExcretionData)}" +
