...
namespace H.Core.Providers.AnaerobicDigestion
{
    ...
    public class Table_45_Parameter_Adjustments_For_Manure_Provider
    {
        ...
        /// <summary>
        /// Method returns a <see cref="Table_45_Parameter_Adjustments_For_Manure_Data"/> based on the parameter. The only valid parameters are
        ...
        /// <returns>Returns an instance of <see cref="Table_45_Parameter_Adjustments_For_Manure_Data"/> containing the parameter values.
        /// If incorrect parameter is specified, the method returns an empty instance.</returns>
        public Table_45_Parameter_Adjustments_For_Manure_Data GetParametersAdjustmentInstance(ManureStateType manureStateType)
        {
