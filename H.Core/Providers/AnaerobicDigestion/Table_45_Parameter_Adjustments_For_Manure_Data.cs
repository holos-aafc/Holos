namespace H.Core.Providers.AnaerobicDigestion
{
    public class Table_45_Parameter_Adjustments_For_Manure_Data
    {
        /// <summary>
        ///     Table 48
        ///     Fixed reduction in VS in stored solid manure entering the digester following a pre-digester storage period. This
        ///     reduction depends on the storage method and is applied to all animal groups
        /// </summary>
