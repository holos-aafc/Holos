...
namespace H.Core.Providers.Carbon
{
    /// <summary>
    /// </summary>
    public class ResidueDataProvider : IResidueDataProvider
    {
        #region Fields

        private List<ResidueData> _data;

        #endregion

        #region Constructors

        public ResidueDataProvider()
        {
        ...
        /// </summary>
        public ResidueData GetResidueData(IrrigationType irrigationType,
                                          ...
                                          Province province)
        {
            ...
            {
                Trace.TraceError($"{nameof(ResidueDataProvider)}.{nameof(this.GetResidueData)}: unknown crop type: '{cropType.GetDescription()}'. Returning default values.");
        ...
        public IEnumerable<ResidueData> GetData()
        {
            ...
            {
                var residueData = new ResidueData();
