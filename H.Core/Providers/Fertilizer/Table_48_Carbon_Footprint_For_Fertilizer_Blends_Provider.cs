...
namespace H.Core.Providers.Fertilizer
{
    ...
    /// </summary>
    public class Table_48_Carbon_Footprint_For_Fertilizer_Blends_Provider : ProviderBase,
        IProvider<Table_48_Carbon_Footprint_For_Fertilizer_Blends_Data>
    {
        #region Constructors
        ...
        public Table_48_Carbon_Footprint_For_Fertilizer_Blends_Provider()
        {
            ...
            {
                expression
                    .CreateMap<Table_48_Carbon_Footprint_For_Fertilizer_Blends_Data,
        ...
        private IEnumerable<Table_48_Carbon_Footprint_For_Fertilizer_Blends_Data> BuildCache()
        {
            ...
            foreach (var line in fileLines.Skip(3))
            {
                ...
                {
                    Trace.Write(
                        $"{nameof(Table_48_Carbon_Footprint_For_Fertilizer_Blends_Provider)}.{nameof(BuildCache)}" +
        ...
        private readonly List<Table_48_Carbon_Footprint_For_Fertilizer_Blends_Data> _cache =
            new List<Table_48_Carbon_Footprint_For_Fertilizer_Blends_Data>();
        ...
        public IEnumerable<Table_48_Carbon_Footprint_For_Fertilizer_Blends_Data> GetData()
        {
            ...
            foreach (var fertilizerBlendData in _cache) result.Add(GetData(fertilizerBlendData.FertilizerBlend));

            return result;
        }

        /// <summary>
        ///     Return a copy of the system blends so that user will always get the original values when adding a new fertilizer
        ///     application. User modifying system blends is not supported
        ///     at this time.
        /// </summary>
