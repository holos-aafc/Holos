...
{
    /// <summary>
    /// Table 51. Carbon FootPrint at plant gate for different fertilizer blends (US numbers) based on Brentrup et al. 2016
    /// </summary>
    public class Table_51_Carbon_Footprint_For_Fertilizer_Blends_Provider : ProviderBase, IProvider<Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data>
    {
        #region Fields

        private readonly FertilizerBlendConverter _converter = new FertilizerBlendConverter();
        private readonly List<Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data> _cache = new List<Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data>();
        ...
        public Table_51_Carbon_Footprint_For_Fertilizer_Blends_Provider()
        {
            var configuration = new MapperConfiguration(expression =>
            {
                expression.CreateMap<Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data, Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data>()
        ...
        public IEnumerable<Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data> GetData()
        {
            var result = new List<Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data>();
        ...
        /// at this time.
        /// </summary>
        public Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data GetData(FertilizerBlends blend)
        {
            var cachedItem = _cache.SingleOrDefault(item => item.FertilizerBlend == blend);
            if (cachedItem != null)
            {
                return _blendMapper.Map<Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data>(cachedItem);
            }
            else
            {
                return null;
        ...
        private IEnumerable<Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data> BuildCache()
        {
            ...
            foreach (var line in fileLines.Skip(3))
            {
                ...
                {
                    Trace.Write($"{nameof(Table_51_Carbon_Footprint_For_Fertilizer_Blends_Provider)}.{nameof(BuildCache)}" +
                ...
                var entry = new Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data();
            ...
            result.Add(new Table_51_Carbon_Footprint_For_Fertilizer_Blends_Data()
            {
