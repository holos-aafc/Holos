...
namespace H.Core.Calculators.Infrastructure
{
    public interface IADCalculator
    {
        ...
        List<DigestorDailyOutput> CalculateResults(Farm farm, List<AnimalComponentEmissionsResults> animalComponentEmissionsResults, ManureTankStore manureTankStore);
    }
}