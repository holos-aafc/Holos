...
namespace H.Core.Calculators.Nitrogen
{
    public class IPCCNitrogenInputCalculator : NitrogenInputCalculatorBase, IIPCCNitrogenInputCalculator
    {
            ...
            CropViewItem previousYearViewItem)
        {
            ...
            var result = belowGroundResidueDryMatter / currentYearViewItem.Area *
                         currentYearViewItem.NitrogenContentInRoots;
        ...
        public double CalculateTotalNitrogenFromExportedResidues(double aboveGroundBiomassExported,
