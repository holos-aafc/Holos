...
namespace H.Core.Calculators.Nitrogen
{
    public partial class N2OEmissionFactorCalculator : IN2OEmissionFactorCalculator
    {
        ...
        {
            if (climateProvider != null) ClimateProvider = climateProvider;

            LivestockEmissionConversionFactorsProvider = new Table_36_Livestock_Emission_Conversion_Factors_Provider();
            AnimalAmmoniaEmissionFactorProvider = new Table_43_Beef_Dairy_Default_Emission_Factors_Provider();
        ...
        private readonly Table_13_Soil_N2O_Emission_Factors_Provider _soilN2OEmissionFactorsProvider =
            new Table_13_Soil_N2O_Emission_Factors_Provider();
        ...
        {
            return CalculateBaseEcodistrictFactor(farm, null, year);
        }
            ...
            int year)
        {
            ...
            var fractionOfLandOccupiedByLowerPortionsOfLandscape =
                _ecodistrictDefaultsProvider.GetFractionOfLandOccupiedByPortionsOfLandscape(
                    soilData.EcodistrictId,
                    soilData.Province);

            var emissionsDueToLandscapeAndTopography = CalculateTopographyEmissions(
                fractionOfLandOccupiedByLowerPortionsOfLandscape,
                farm.GetGrowingSeasonPrecipitation(year),
                farm.GetGrowingSeasonEvapotranspiration(year));

            var baseEcodistrictFactor = CalculateBaseEcodistrictValue(
                emissionsDueToLandscapeAndTopography,
            ...
            if (viewItem != null)
            {
                ...
                viewItem.FractionOfLandOccupiedByLowerPortionsOfLandscape =
                    fractionOfLandOccupiedByLowerPortionsOfLandscape;
                viewItem.WeightedModifierBasedOnTexture =
                    CalculateModifierBasedOnTexture(soilData.SoilTexture, soilData.Province.GetRegion(), 1);
            }
        ...
        public double CalculateSyntheticNitrogenEmissionFactor(
            ...
            Farm farm)
        {
            if (viewItem == null) return 0;

            if (farm.Defaults.UseCustomN2OEmissionFactor) return farm.Defaults.CustomN2OEmissionFactor;

            var baseEcodistrictFactor = CalculateBaseEcodistrictFactor(farm, viewItem, viewItem.Year);
            ...
            var nitrogenSourceModifier = _soilN2OEmissionFactorsProvider.GetFactorForNitrogenSource(
                Table_13_Soil_N2O_Emission_Factors_Provider.NitrogenSourceTypes.SyntheticNitrogen,
                viewItem);

            var soilReductionFactor =
                _soilN2OEmissionFactorsProvider
                    .GetReductionFactorBasedOnApplicationMethod(viewItem.SoilReductionFactor);
            if (viewItem.SoilReductionFactor == SoilReductionFactors.Custom)
                soilReductionFactor = viewItem.CustomReductionFactor;

            var syntheticNitrogenEmissionFactor = CalculateEmissionFactor(
                baseEcodistrictFactor,
                croppingSystemModifier,
                tillageModifier,
                nitrogenSourceModifier,
                soilReductionFactor);
        ...
        public double CalculateOrganicNitrogenEmissionFactor(Farm farm, int year)
        {
            ...
            var nitrogenSourceModifier = _soilN2OEmissionFactorsProvider.GetFactorForNitrogenSource(
                Table_13_Soil_N2O_Emission_Factors_Provider.NitrogenSourceTypes.OrganicNitrogen);
            ...
            var organicNitrogenEmissionFactor = CalculateEmissionFactor(
                baseEcodistrictFactor,
                croppingSystemModifier,
                tillageModifier,
                nitrogenSourceModifier);
            ...
            Farm farm)
        {
            ...
            var ecodistrictManureEmissionFactor = CalculateEmissionFactor(
                baseEcodistrictFactor,
                croppingSystemModifier,
                tillageModifier,
                nitrogenSourceModifier);
            ...
            Farm farm)
        {
            ...
            var cropResidueModifier = _soilN2OEmissionFactorsProvider.GetFactorForNitrogenSource(
                Table_13_Soil_N2O_Emission_Factors_Provider.NitrogenSourceTypes.CropResidueNitrogen,
                viewItem);

            var emissionFactorForCropResidues = CalculateEmissionFactor(
                baseEcodistrictFactor,
                croppingSystemModifier,
                tillageModifier,
                cropResidueModifier);
        ...
        ///     <para>
        ///         Implements: Table 14. Coefficients used for the Bouwman et al. (2002) equation, which was of the form:
        ///         emission factor (%) = 100 x exp (sum of relevant coefficients)
        ///     </para>
        /// </summary>
            ...
            Farm farm)
        {
            ...
            foreach (var fertilizerApplicationViewItem in cropViewItem.FertilizerApplicationViewItems)
            {
                ...
                else if (fertilizerApplicationViewItem.FertilizerBlendData.FertilizerBlend ==
                         FertilizerBlends.UreaAmmoniumNitrate)
            ...
            foreach (var fertilizerApplicationViewItem in cropViewItem.FertilizerApplicationViewItems)
            {
                ...
                if (fertilizerApplicationViewItem.FertilizerApplicationMethodology ==
            ...
            var result = Math.Exp(cropTypeFactor + fertilizerTypeFactor + methodOfApplicationFactor + soilPhFactor +
                                  soilCecFactor + temperatureFactor);
            ...
            double potentialEvapotranspiration)
        {
            ...
            {
                var result = CalculateEmissionFactorUsingPrecipitation(precipitation);

                return result;
            }
            else
            {
                var result = CalculateEmissionFactorUsingPotentialEvapotranspiration(potentialEvapotranspiration);
        ...
        ///     Equation 2.5.2-3
        /// </summary>
        /// <param name="fractionOfLandOccupiedByLowerPortionsOfLandscape">
        ///     Fraction of land occupied by lower portions of landscape
        ///     (from Rochette et al. 2008)
        /// </param>
        ...
        {
            if (Math.Abs(growingSeasonEvapotranspiration) < double.Epsilon) return 0;

            var emissionFactorUsingPotentialEvapotranspiration =
                CalculateEmissionFactorUsingPotentialEvapotranspiration(growingSeasonEvapotranspiration);
            var emissionFactorUsingPrecipitation =
                CalculateEmissionFactorUsingPrecipitation(growingSeasonPrecipitation);

            var emissionFactorForIrrigatedSites = emissionFactorUsingPotentialEvapotranspiration;
            var emissionFactorForHumidEnvironments =
                CalculateEcodistrictEmissionFactor(growingSeasonPrecipitation, growingSeasonEvapotranspiration);
            var emissionFactorForDryEnvironments =
                emissionFactorUsingPotentialEvapotranspiration * fractionOfLandOccupiedByLowerPortionsOfLandscape +
                emissionFactorUsingPrecipitation * (1 - fractionOfLandOccupiedByLowerPortionsOfLandscape);
        ...
        /// <param name="fractionOfThisTexture">
        ///     The fraction of the ecodistrict that is comprised of this soil texture type (100%
        ///     for now)
        /// </param>
        ...
        ///     Equation 2.5.3-2
        /// </summary>
        /// <param name="topographyEmission">
        ///     N2O emission factor adjusted due to position in landscape and moisture regime (kg
        ///     N2O-N)
        /// </param>
        /// <param name="soilTexture">The soil texture of the ecodistrict</param>
        /// <param name="region">The region of the ecodistrict</param>
        /// <returns>
        ///     A function of the three factors that create a base ecodistrict specific value that accounts for the climatic,
        ///     topographic and edaphic characteristics of the spatial unit for lands
        /// </returns>
        public double CalculateBaseEcodistrictValue(
            ...
            Region region)
        {
            var textureModifier = CalculateModifierBasedOnTexture(
                soilTexture,
                region,
                /*
        ...
        ///     Equation 2.5.4-1
        /// </summary>
        /// <param name="baseEcodistictEmissionFactor">
        ///     A function of the three factors that create a base ecodistrict specific
        ///     value that accounts for the climatic, topographic and edaphic characteristics of the spatial unit for lands
        /// </param>
        ...
        /// <param name="nitrogenSourceModifier">
        ///     N source modifier RF_NSk (SN = Synthetic Nitrogen; ON = Organic Nitrogen; CRN =
        ///     Crop Residue Nitrogen)
        /// </param>
        /// <param name="applicationMethodReductionFactor">
        ///     Reduction factor based on application method, only applicable to
        ///     calculations of EF specific for SN
        /// </param>
        /// <returns>
        ///     The EF considering the impact of the N source on the cropping system and site dependent factors associated
        ///     with rainfall, topography, soil texture, N source type, tillage, cropping system and moisture managment (kg N2O-N
        ///     kg-1 N) for ecodistrict ‘‘i’’.
        /// </returns>
        ...
        {
            var result = baseEcodistictEmissionFactor * croppingSystemModifier * tillageModifier *
                         nitrogenSourceModifier * applicationMethodReductionFactor;
        ...
        /// <summary>
        ///     Combines total emissions for entire area of a field from each manure/digestate application into per hectare
        ///     emissions
        /// </summary>
        /// <param name="results">The emissions for each field</param>
        /// <param name="viewItem">
        ///     The <see cref="H.Core.Models.LandManagement.Fields.CropViewItem" /> that will be used to
            ...
            CropViewItem viewItem)
        {
            ...
            foreach (var landApplicationEmissionResult in results)
            {
                ...
                totalAmountsPerHectareFromManureApplications.TotalN2ONFromManureLeaching +=
                    landApplicationEmissionResult.TotalN2ONFromManureLeaching > 0
                        ? landApplicationEmissionResult.TotalN2ONFromManureLeaching / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.TotalIndirectN2ONEmissions +=
                    landApplicationEmissionResult.TotalIndirectN2ONEmissions > 0
                        ? landApplicationEmissionResult.TotalIndirectN2ONEmissions / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.TotalNitrateLeached +=
                    landApplicationEmissionResult.TotalNitrateLeached > 0
                        ? landApplicationEmissionResult.TotalNitrateLeached / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.TotalIndirectN2OEmissions +=
                    landApplicationEmissionResult.TotalIndirectN2OEmissions > 0
                        ? landApplicationEmissionResult.TotalIndirectN2OEmissions / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.TotalN2OFromManureVolatilized +=
                    landApplicationEmissionResult.TotalN2OFromManureVolatilized > 0
                        ? landApplicationEmissionResult.TotalN2OFromManureVolatilized / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.TotalN2ONFromManureVolatilized +=
                    landApplicationEmissionResult.TotalN2ONFromManureVolatilized > 0
                        ? landApplicationEmissionResult.TotalN2ONFromManureVolatilized / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.TotalVolumeOfManureUsedDuringApplication +=
                    landApplicationEmissionResult.TotalVolumeOfManureUsedDuringApplication > 0
                        ? landApplicationEmissionResult.TotalVolumeOfManureUsedDuringApplication / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.AmmoniacalLoss +=
                    landApplicationEmissionResult.AmmoniacalLoss > 0
                        ? landApplicationEmissionResult.AmmoniacalLoss / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.AdjustedAmmoniaLoss +=
                    landApplicationEmissionResult.AdjustedAmmoniaLoss > 0
                        ? landApplicationEmissionResult.AdjustedAmmoniaLoss / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.AdjustedAmmoniacalLoss +=
                    landApplicationEmissionResult.AdjustedAmmoniacalLoss > 0
                        ? landApplicationEmissionResult.AdjustedAmmoniacalLoss / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.AmmoniaLoss +=
                    landApplicationEmissionResult.AmmoniaLoss > 0
                        ? landApplicationEmissionResult.AmmoniaLoss / viewItem.Area
                        : 0;

                totalAmountsPerHectareFromManureApplications.ActualAmountOfNitrogenAppliedFromLandApplication +=
                    landApplicationEmissionResult.ActualAmountOfNitrogenAppliedFromLandApplication > 0
                        ? landApplicationEmissionResult.ActualAmountOfNitrogenAppliedFromLandApplication / viewItem.Area
                        : 0;

                // Equation 4.6.2-4
                totalAmountsPerHectareFromManureApplications.TotalTANApplied +=
                    landApplicationEmissionResult.TotalTANApplied > 0
