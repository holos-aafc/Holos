...
namespace H.Core.Converters
{
    ...
    {
        private readonly SlcToHardinessZoneProvider provider = new SlcToHardinessZoneProvider();
        ...
        public List<WeightedHardinessZone> Convert(int SlcID)
        {
            ...
            var result = new List<WeightedHardinessZone>();
            if (entry == null) return result;
            if (entry.H0bProportion > 0)
            {
                var r = new WeightedHardinessZone();
