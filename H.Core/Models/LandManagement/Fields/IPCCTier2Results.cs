...
{
    /// <summary>
    ///     A class to hold intermediate results when running the IPCC Tier 2 model. Results will hold values related to N or C
    ///     depending on the <see cref="CalculationMode" />
    /// </summary>
