...
public class UnitsOfMeasurementCalculatorTest
{
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsPerHectare, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.MillimetersPerYear, 50.0);
        Assert.AreEqual(1.97, convertedValue);
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.DegreesCelsius, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.MegaJoulesPerKilogram, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.MilligramsPerKilogram, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.InternationalUnitsPerGram, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramPerKilogram, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramPerHeadPerYear, 50.0);
        Assert.AreEqual(110.25, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramPerHeadPerDay, 50.0);
        Assert.AreEqual(110.25, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsN2ONPerKilogramN, 50.0);
        Assert.AreEqual(110.25, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsNitrogenPerHectare, 50.0);
        Assert.AreEqual(44.6158, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsPhosphorousPerHectare, 50.0);
        Assert.AreEqual(44.6158, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(
                MetricUnitsOfMeasurement.CubicMetersMethanePerKilogramVolatileSolids, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsMethanePerKilogramMethane,
                50.0);
        Assert.AreEqual(110.25, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.MegaJoulesPerDayPerKilogram, 50.0);
        Assert.AreEqual(21492.4487, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsNitrogenPerKilogram, 50.0);
        Assert.AreEqual(110.25, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.GigajoulesPerHectare, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsPerDay, 50.0);
        Assert.AreEqual(110.25, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsCarbonPerHectare, 50.0);
        Assert.AreEqual(44.6158, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsCarbonPerTree, 50.0);
        Assert.AreEqual(110.25, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsCarbonPerPlanting, 50.0);
        Assert.AreEqual(110.25, Math.Round(convertedValue, 4));
    }
    ...
    [TestMethod]
    public void
        ConverterValueToImperialFromMetric_KilogramsCarbonDioxidePerShelterbeltToPoundsCarbonDioxidePerShelterbelt()
    {
        var convertedValue =
            _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.KilogramsCarbonDioxidePerShelterbelt,
                50.0);
        Assert.AreEqual(110.25, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertKilogramsPerHectareToImperialBushelPerAcresBasedOnCropType(CropType.Barley, 50);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.InchesPerYear, 50.0);
        Assert.AreEqual(1269.0355, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.DegreesFahrenheit, 50.0);
    ...
    public void ConverterValueToIMetricFromImperial_BTUPerPoundToMegaJoulesPerKilogram()
    {
        var convertedValue = _calculator.ConvertValueToMetricFromImperial(
            ImperialUnitsOfMeasurement.BritishThermalUnitPerPound, 50.0,
            MetricUnitsOfMeasurement.MegaJoulesPerKilogram);
    ...
    public void ConverterValueToIMetricFromImperial_BTUPerPoundToKiloCaloriePerKilogram()
    {
        var convertedValue = _calculator.ConvertValueToMetricFromImperial(
            ImperialUnitsOfMeasurement.BritishThermalUnitPerPound, 50.0,
            MetricUnitsOfMeasurement.KiloCaloriePerKilogram);
    ...
    public void ConvertValueTOMetricFromImperial_BTUPerPoundToMegaCaloriePerKilogram()
    {
        var convertedValue = _calculator.ConvertValueToMetricFromImperial(
            ImperialUnitsOfMeasurement.BritishThermalUnitPerPound, 50.0,
            MetricUnitsOfMeasurement.MegaCaloriePerKilogram);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.GrainsPerPound, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.InternationalUnitsPerGrain, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundsPerPound, 50.0);
        Assert.AreEqual(22.6757, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundPerHeadPerYear, 50.0);
        Assert.AreEqual(22.6757, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundPerHeadPerDay, 50.0);
        Assert.AreEqual(22.6757, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundsN2ONPerPoundN, 50.0);
        Assert.AreEqual(22.6757, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundsNitrogenPerAcre, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(
                ImperialUnitsOfMeasurement.CubicYardsMethanePerPoundVolatileSolids, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundsMethanePerPoundMethane, 50.0);
        Assert.AreEqual(22.6757, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.BritishThermalUnitPerDayPerPound,
                50.0);
        Assert.AreEqual(0.1163, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundsNitrogenPerPound, 50.0);
        Assert.AreEqual(22.6757, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.BritishThermalUnitsPerAcre, 50.0);
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundsPerDay, 50.0);
        Assert.AreEqual(22.6757, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundsCarbonPerAcre, 50.0);
        Assert.AreEqual(56.0340, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundsCarbonPerTree, 50.0);
        Assert.AreEqual(22.6757, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.PoundsCarbonPerPlanting, 50.0);
        Assert.AreEqual(22.6757, Math.Round(convertedValue, 4));
    }
    ...
    {
        var convertedValue =
            _calculator.ConvertBushelsPerAcreToMetricKilogramsPerHectareBasedOnCropType(CropType.Barley, 0.9295);
    ...
    {
        var value = _calculator.ConvertValueToImperialFromMetric(
            MetricUnitsOfMeasurement.KilogramVolatileSolidsPerCubicMeterPerDay, 1.6);
    ...
    {
        var value = _calculator.ConvertValueToMetricFromImperial(
            ImperialUnitsOfMeasurement.PoundVolatileSolidsPerCubicYardPerDay, 25);
    ...
    {
        var value = _calculator.ConvertValueToMetricFromImperial(ImperialUnitsOfMeasurement.MethanePerCubicYardPerDay,
            12);
    ...
    {
        var value = _calculator.ConvertValueToImperialFromMetric(MetricUnitsOfMeasurement.MethanePerCubicMeterPerDay,
            3);
