...
public class N2OEmissionFactorCalculatorTest : UnitTestBase
{
    ...
    public void TestInitialize()
    {
        ...
        _sut.ClimateProvider = _mockClimateProviderObject;
        _sut.LivestockEmissionConversionFactorsProvider = _mockEmissionDataProviderObject;
        _sut.AnimalAmmoniaEmissionFactorProvider = _mockAnimalAmmoniaEmissionFactorProviderObject;
        ...
        _mockManureService.Setup(x =>
                x.GetAmountOfTanUsedDuringLandApplication(It.IsAny<CropViewItem>(),
                    It.IsAny<ManureApplicationViewItem>()))
            .Returns(25);
        _mockManureService
            .Setup(x => x.GetTotalTanAppliedToAllFields(It.IsAny<int>(), It.IsAny<List<CropViewItem>>())).Returns(
                new List<Tuple<double, AnimalType>> { new(100, AnimalType.Beef) });
        ...
        _mockClimateProvider.Setup(x => x.GetAnnualEvapotranspiration(It.IsAny<Farm>(), It.IsAny<DateTime>()))
            .Returns(8);
        _mockClimateProvider.Setup(x => x.GetGrowingSeasonEvapotranspiration(It.IsAny<Farm>(), It.IsAny<DateTime>()))
            .Returns(2);
        _mockClimateProvider.Setup(x => x.GetGrowingSeasonPrecipitation(It.IsAny<Farm>(), It.IsAny<DateTime>()))
            .Returns(3);
        ...
        _mockClimateProvider.Setup(x => x.GetGrowingSeasonEvapotranspiration(It.IsAny<Farm>(), It.IsAny<int>()))
            .Returns(2);
        ...
        _mockEmissionDataProvider.Setup(x =>
            x.GetVolatilizationFractionForLandApplication(It.IsAny<AnimalType>(), It.IsAny<Province>(),
                It.IsAny<int>())).Returns(0.1);
        _mockEmissionDataProvider
            .Setup(x => x.GetEmissionFactorForVolatilizationBasedOnClimate(It.IsAny<double>(), It.IsAny<double>()))
            .Returns(0.2);

        _mockAnimalAmmoniaEmissionFactorProvider
            .Setup(x => x.GetAmmoniaEmissionFactorForSolidAppliedManure(It.IsAny<TillageType>())).Returns(1);
        _mockAnimalAmmoniaEmissionFactorProvider.Setup(x =>
            x.GetAmmoniaEmissionFactorForLiquidAppliedManure(It.IsAny<ManureApplicationTypes>())).Returns(1);

        _viewItem = GetTestCropViewItem();
        ...
        var climateData = GetTestClimateData();
    ...
    public void CalculateTotalN2ONFromExportedManure()
    {
        ...
        farm.StageStates.Add(GetFieldStageState());
    ...
    public void CalculateTotalIndirectEmissionsFromFieldSpecificManureApplications()
    {
        ...
        var n2oFromManureVolatilized =
            _sut.CalculateTotalManureN2OVolatilizationForField(viewItem, farm, viewItem.Year);
        Assert.AreEqual(960.521370938372, n2oFromManureVolatilized, 0.0001);

        var adjustedAmmoniacalLoss =
            _sut.CalculateTotalAdjustedAmmoniaEmissionsFromLandAppliedManureForField(farm, viewItem, viewItem.Year);
    ...
    public void CalculateTotalIndirectEmissionsFromFieldSpecificManureApplicationsUsingMultipleAnimalResults()
    {
        ...
        var dairyApplication = GetTestBeefCattleManureApplicationViewItemUsingOnLivestockManure();
    ...
    public void CalculateAmmoniaFromLandApplicationForImportedManure()
    {
        ...
        viewItem.ManureApplicationViewItems.Add(GetTestBeefCattleManureApplicationViewItemUsingImportedManure());
        ...
        var adjustedAmmoniacalLoss =
            _sut.CalculateTotalAdjustedAmmoniacalEmissionsFromImportsForField(farm, viewItem, viewItem.Year);
    ...
    public void CalculateAmmoniaFromLandApplicationForMultipleImportedManureApplications()
    {
        ...
        viewItem.ManureApplicationViewItems.Clear();
        viewItem.ManureApplicationViewItems.Add(GetTestBeefCattleManureApplicationViewItemUsingImportedManure());
        viewItem.ManureApplicationViewItems.Add(GetTestDairyCattleManureApplicationViewItemUsingImportedManure());
    ...
    public void CalculateAmmoniaFromLandApplicationForDigestate()
    {
        ...
        var digestateApplication = GetTestRawDigestateApplicationViewItem();
        ...
        var ammoniacalLoss =
            _sut.CalculateNH3NLossFromFarmSourcedLandAppliedDigestateForField(farm, viewItem, viewItem.Year);
        Assert.AreEqual(10, ammoniacalLoss, 2);
        ...
        var adjustedAmmoniacalLoss =
            _sut.CalculateAdjustedDigestateNH3NEmissionsForField(farm, viewItem, viewItem.Year);
    ...
    public void CalculateAmmoniaFromLandApplicationForMultipleDigestateApplications()
    {
        ...
        var digestateApplication = GetTestRawDigestateApplicationViewItem();
        var digestateApplication2 = GetTestLiquidDigestateApplicationViewItem();
    ...
    public void CalculateAmmoniaEmissionsFromExportedManure()
    {
        ...
        _mockManureService.Setup(x => x.GetManureTypesExported(It.IsAny<Farm>(), It.IsAny<int>()))
            .Returns(new List<AnimalType> { AnimalType.Beef });
        _mockManureService.Setup(x =>
                x.GetTotalNitrogenFromExportedManure(It.IsAny<int>(), It.IsAny<Farm>(), It.IsAny<AnimalType>()))
            .Returns(100);
    ...
    public void CalculateAmmoniaEmissionsFromImportedManure()
    {
        ...
        var application = GetTestDairyCattleManureApplicationViewItemUsingImportedManure();
        cropViewItem.ManureApplicationViewItems.Add(application);

        _mockManureService.Setup(x => x.GetManureTypesImported(It.IsAny<Farm>(), It.IsAny<int>()))
            .Returns(new List<AnimalType> { AnimalType.Dairy });
        _mockManureService.Setup(x =>
                x.GetTotalNitrogenFromManureImports(It.IsAny<int>(), It.IsAny<Farm>(), It.IsAny<AnimalType>()))
            .Returns(100);
    ...
    {
        _mockManureService
            .Setup(x => x.GetTotalManureNitrogenRemainingForFarmAndYear(It.IsAny<int>(), It.IsAny<Farm>()))
            .Returns(600);
    ...
    [TestMethod]
    public void
        GetTotalDigestateNitrogenAppliedFromLivestockAndImportsInYearWhenNoLocalOrImportedDigestateApplicationsMade()
    {
        var viewItem = GetTestCropViewItem();
        var farm = GetTestFarm();
        var field = GetTestFieldComponent();
    ...
    public void GetTotalDigestateNitrogenAppliedFromLivestockAndImportsInYearReturnsNonZeroWhenLocalApplicationMade()
    {
        ...
        viewItem.DigestateApplicationViewItems.Add(new DigestateApplicationViewItem
        {
            ManureLocationSourceType = ManureLocationSourceType.Livestock, DateCreated = DateTime.Now,
    ...
    public void GetTotalDigestateNitrogenAppliedFromLivestockAndImportsInYearReturnsNonZeroWhenImportedApplicationMade()
    {
        ...
        viewItem.DigestateApplicationViewItems.Add(new DigestateApplicationViewItem
        {
            ManureLocationSourceType = ManureLocationSourceType.Imported, DateCreated = DateTime.Now,
            AmountOfNitrogenAppliedPerHectare = 100
        });
    ...
    [TestMethod]
    public void
        GetTotalDigestateNitrogenAppliedFromLivestockAndImportsInYearReturnsNonZeroWhenImportedApplicationAndLocalMade()
    {
        var viewItem = GetTestCropViewItem();
        var farm = GetTestFarm();
        var field = GetTestFieldComponent();
    ...
    [TestMethod]
    public void
        CalculateDirectN2ONEmissionsFromFieldSpecificDigestateSpreadingForFieldReturnsZeroWhenFieldIsNativeRangeland()
    {
        var viewItem = GetTestCropViewItem();
    ...
    [TestMethod]
    public void
        CalculateDirectN2ONEmissionsFromFieldSpecificDigestateSpreadingForFieldReturnsZeroWhenNoApplicationsMade()
    {
    ...
    [TestMethod]
    public void
        CalculateDirectN2ONEmissionsFromFieldSpecificDigestateSpreadingForFieldReturnsNonZeroWhenLivestockApplicationsMade()
    {
        _viewItem.DigestateApplicationViewItems.Add(new DigestateApplicationViewItem
        {
            ManureLocationSourceType = ManureLocationSourceType.Livestock, DateCreated = DateTime.Now,
            AmountOfNitrogenAppliedPerHectare = 100
        });
    ...
    [TestMethod]
    public void
        CalculateDirectN2ONEmissionsFromFieldSpecificDigestateSpreadingForFieldReturnsNonZeroWhenLivestockAndImportApplicationsMade()
    {
        _viewItem.DigestateApplicationViewItems.Add(new DigestateApplicationViewItem
        {
            ManureLocationSourceType = ManureLocationSourceType.Imported, DateCreated = DateTime.Now,
    ...
    public void GetTotalManureVolumeAppliedFromLivestockAndImportsInYear()
    {
        ...
        _viewItem.ManureApplicationViewItems.Add(new ManureApplicationViewItem
        {
            ManureLocationSourceType = ManureLocationSourceType.Livestock, DateOfApplication = DateTime.Now,
            AmountOfManureAppliedPerHectare = 100
        });
        _viewItem.ManureApplicationViewItems.Add(new ManureApplicationViewItem
        {
            ManureLocationSourceType = ManureLocationSourceType.Imported, DateOfApplication = DateTime.Now,
            AmountOfManureAppliedPerHectare = 100
        });
    ...
    {
        var farm = GetTestFarm();
        farm.GeographicData = GetTestGeographicData();
        var climate = GetTestClimateData();
        ...
        var fieldWithManureApplication = GetTestFieldComponent();
    ...
    {
        var farm = new Farm();
        var manureExportViewItem = GetTestManureExportViewItem();
