...
public class CarbonServiceTest : UnitTestBase
{
    ...
    public void CalculateCarbonLostFromHayExportForField()
    {
        ...
        hayExportViewItem.HarvestViewItems.Add(new HarvestViewItem
            { TotalNumberOfBalesHarvested = 20, Start = DateTime.Now });
        ...
        importingViewItem.HayImportViewItems.Add(new HayImportViewItem
        {
            Start = DateTime.Now, FieldSourceGuid = fieldId, NumberOfBales = 5, MoistureContentAsPercentage = 20,
            BaleWeight = 100
        });
    ...
    [TestMethod]
    public void
        CalculateTotalDryWeightLossFromResiduesTestReturnsNonZeroWhenExportingFieldIsNotTheSameAsImportingField()
    {
