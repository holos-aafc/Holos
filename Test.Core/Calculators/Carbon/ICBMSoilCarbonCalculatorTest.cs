...
public class ICBMSoilCarbonCalculatorTest : UnitTestBase
{
    ...
    /// <summary>
    ///     The results from this test match closely with a farm set up in v3 that uses the same growing season precipitation,
    ///     yield, and soil data
    ...
    public void CalculateCropN2OEmissions()
    {
        ...
        var cropViewItem = new CropViewItem
        {
            ...
            NitrogenFertilizerRate =
                100, // There has to be an amount of fertilizer applied for the direct N emission to be larger than the indirect N emissions. If this is 0 then the direct and indirect will be almost equal
            Yield = 1000,
        ...
        farm.StageStates.Add(new FieldSystemDetailsStageState
            { DetailsScreenViewCropViewItems = new ObservableCollection<CropViewItem> { cropViewItem } });
        ...
        _soilCarbonInputCalculator.AssignInputs(null, cropViewItem, null, farm,
            new List<AnimalComponentEmissionsResults>());
        ...
        var directN2OAsCO2 = cropViewItem.TotalDirectNitrousOxidePerHectare * cropViewItem.Area *
                             CoreConstants.N2OToCO2eConversionFactor;
        var indirectN2OAsCO2 = cropViewItem.TotalIndirectNitrousOxidePerHectare * cropViewItem.Area *
                               CoreConstants.N2OToCO2eConversionFactor;
    ...
    public void CalculateOldPoolSteadyState()
    {
        ...
        var youngPoolSteadyStateAboveGround =
            1.0; //_sut.CalculateYoungPoolSteadyStateAboveGround(aboveGroundCarbonInput, youngPoolDecompostionRate, climateParamter);
        var youngPoolSteadyStateBelowGround =
            2.0; //_sut.CalculateYoungPoolSteadyStateBelowGround(belowGroundCarbonInput, youngPoolDecompostionRate, climateParamter);
