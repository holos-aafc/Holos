...
public class ICBMCarbonInputCalculatorTest : UnitTestBase
{
    ...
    public void CalculateAboveGroundCarbonInputForAnnuals()
    {
        ...
        _sut.AssignInputs(
            ...
            currentYearViewItem,
            nextYearViewItem,
            farm, new List<AnimalComponentEmissionsResults>());
    ...
    public void CalculateAboveGroundCarbonInputForPerennials()
    {
        var currentYearViewItem = new CropViewItem
        {
            ...
            PercentageOfStrawReturnedToSoil =
                0, // This will be set to zero for the user when they have selected a perennial
            CarbonConcentration = 0.45,
            IrrigationType = IrrigationType.RainFed,
            AmountOfIrrigation = 0,
    ...
    [TestMethod]
    public void
        CalculateAboveGroundCarbonInputForPerennialsWhenPlantCarbonForAgriculturalProductIsUnknownInCurrentYearButKnownInNextYear()
    {
        var currentYearViewItem = new CropViewItem
        {
            CropType = CropType.TameMixed,
    ...
    [TestMethod]
    public void
        CalculateAboveGroundCarbonInputForPerennialsWhenPlantCarbonForAgriculturalProductIsUnknownInCurrentYearAndIsUnknownInNextYear()
    {
        var currentYearViewItem = new CropViewItem
        {
            CropType = CropType.TameMixed,
    ...
    public void CalculatePlantCarbonInAgriculturalProduct()
    {
        ...
        Assert.AreEqual(507.69, result, 2);
    }
    ...
    public void CalculateProductivity()
    {
        ...
        var result = _sut.CalculateProductivity(
            ...
            proportionOfPrecipitationMayToSeptember,
            carbonConcentration);
    ...
    public void CalculateAboveGroundCarbonInputForSilage()
    {
        var currentYearViewItem = new CropViewItem
        {
            ...
            PercentageOfStrawReturnedToSoil =
                0, // This will be set to zero for the user when they have selected a silage
            CarbonConcentration = 0.45,
            IrrigationType = IrrigationType.RainFed,
            AmountOfIrrigation = 0,
            MoistureContentOfCrop = 0.12,
    ...
    /// <summary>
    ///     Test above ground carbon input calculation when the user enters the 'main' crop as a cover crop i.e. 'Winter Wheat'
    ///     (instead of specifying fallow for that crop).
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    ///     Test below ground carbon input calculation when the user enters the 'main' crop as a cover crop i.e. 'Winter Wheat'
    ///     (instead of specifying fallow for that crop).
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    ///     Test above ground carbon input calculation when the user enters the 'main' crop (i.e. 'Winter Wheat') as a cover
    ///     crop and also specifies
    ...
    /// <summary>
    ///     Test below ground carbon input calculation when the user enters the 'main' crop (i.e. 'Winter Wheat') as a cover
    ///     crop and also specifies
    ///     green manure harvest type.
    /// </summary>
    [TestMethod]
