...
public class SummationsCalculatorTest
{
    ...
    public void CalculateEntericMethaneEmissionFromLivestockToMgGlobalWarming()
    {
        ...
        var result =
            calc.CalculateEntericMethaneEmissionFromLivestockToMgGlobalWarming(
                totalEntericMethaneEmissionsFromLivestock);
    ...
    public void CalculateManureDirectNitrousOxideEmissionFromLivestockToMgGlobalWarming()
    {
        ...
        var result =
            calc.CalculateManureDirectNitrousOxideEmissionFromLivestockToMgGlobalWarming(
                totalManureDirectNitrousOxideEmissionsFromLivestock);
    ...
    {
        var result =
            calc.CalculateTotalAnnualFarmCarbonDioxideEQEmissionsMg(14.8, 5.76, 6.66, 0.012, 0.015, 0.805, 12.15,
                73.112);
