...
public class ClimateParameterCalculatorTest
{
    ...
    public void DailyClimateInputTest()
    {
        ...
        var file = Resource1.climate_parameter_tool_input
    ...
    {
        var cropCoefficient = _sut.CalculateCropCoefficient(30.3, 21.5, CropType.AlfalfaSeed);
    ...
    {
        var result =
            _sut.CalculateCropSpecificEvapotranspirationNoWaterAvailability(30.3, 21.5, CropType.AlfalfaSeed, 12, 1,
                30);
