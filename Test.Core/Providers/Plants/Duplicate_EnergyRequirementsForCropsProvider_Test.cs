...
public class Duplicate_EnergyRequirementsForCropsProvider_Test
{
    ...
    public void GetEnergyDataForCropInWesternCanadaTest()
    {
        ...
        var result = provider.GetEnergyData(Province.Alberta, SoilFunctionalCategory.Black, TillageType.Intensive,
            CropType.Barley);
    ...
    public void GetEnergyDataForFallowInWesternCanadaTest()
    {
        ...
        var result = provider.GetEnergyData(Province.Alberta, SoilFunctionalCategory.BlackGrayChernozem,
            TillageType.Reduced, CropType.Fallow);
    ...
    public void GetEnergyDataForCropInEasternCanadaTest()
    {
        ...
        var result = provider.GetEnergyData(Province.NewBrunswick, SoilFunctionalCategory.EasternCanada,
            TillageType.Intensive, CropType.TameGrass);
    ...
    public void GetEnergyDataTest()
    {
        ...
        var smallGrainCerealsAlbertaBlackIntensive = provider.GetEnergyData(Province.Alberta,
            SoilFunctionalCategory.Black, TillageType.Intensive, CropType.SmallGrainCereals);
        ...
        var smallGrainCerealsAlbertaBlackReduced = provider.GetEnergyData(Province.Alberta,
            SoilFunctionalCategory.Black, TillageType.Reduced, CropType.SmallGrainCereals);
        ...
        var smallGrainCerealsAlbertaBlackNoTill = provider.GetEnergyData(Province.Alberta, SoilFunctionalCategory.Black,
            TillageType.NoTill, CropType.SmallGrainCereals);
