...
public class Table_7_Relative_Biomass_Information_Provider_Test
{
    ...
    {
        var result = _sut.GetResidueData(IrrigationType.Irrigated, 202, CropType.Canola, SoilFunctionalCategory.Brown,
            Province.Alberta);
    ...
    {
        var result = _sut.GetResidueData(IrrigationType.RainFed, 0, CropType.Oilseeds, SoilFunctionalCategory.Brown,
            Province.Alberta);
    ...
    public void GetOats()
    {
        var result = _sut.GetResidueData(IrrigationType.RainFed, 0, CropType.Oats, SoilFunctionalCategory.Brown,
            Province.Alberta);
    ...
    {
        var data = _sut.GetResidueData(IrrigationType.RainFed, 0, CropType.SmallGrainCereals,
            SoilFunctionalCategory.Black, Province.Alberta);
        Assert.AreEqual(0.073, data.LigninContent);

        data = _sut.GetResidueData(IrrigationType.RainFed, 0, CropType.AlfalfaMedicagoSativaL,
            SoilFunctionalCategory.DarkBrown, Province.Alberta);
