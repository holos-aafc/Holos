...
[TestClass]
public class Table_33_Daily_Feed_Intake_Swine_Provider_Test
{
    private Table_33_Daily_Feed_Intake_Swine_Provider _provider;

    [TestInitialize]
    public void TestInitialize()
    {
        _provider = new Table_33_Daily_Feed_Intake_Swine_Provider();
    }
