...
[TestClass]
public class Table_42_Poultry_OtherLivestock_Default_NExcretionRates_Provider_Test
{
    #region Fields
    ...
    {
        _provider = new Table_42_Poultry_OtherLivestock_Default_NExcretionRates_Provider();
    }
