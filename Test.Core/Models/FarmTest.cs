...
public class FarmTest : UnitTestBase
{
    ...
    public void GetManureApplicationsForMonthTest()
    {
        ...
        var result = farm.GetManureApplicationsForMonth(
            new MonthsAndDaysData { StartDay = 9, Year = DateTime.Now.Year, Month = 3, DaysInMonth = 2 },
            AnimalType.Beef);
    ...
    public void TotalVolumeAppliedOfManureAppliedForMonth()
    {
        ...
        var monthsAndDaysData = new MonthsAndDaysData
            { StartDay = 9, Year = DateTime.Now.Year, Month = 3, DaysInMonth = 2 };
