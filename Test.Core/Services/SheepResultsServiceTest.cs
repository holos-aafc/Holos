...
public class SheepResultsServiceTest
{
    ...
    public void CalculateNetEnergyForLactationReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateNetEnergyForLactation(dailyWeightGainOfLambs,
                energyRequiredToProduceAKilogramOfMilk);
    ...
    public void CalculateNetEnergyForGainReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateNetEnergyForGain(averageDailyGain, averageWeight, coefficientA, coefficientB);
    ...
    public void CalculateEntericMethaneEmissionRateReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateEntericMethaneEmissionRateForSheep(grossEnergyIntake, methaneConversionFactor);
    ...
    public void CalculateManureMethaneEmissionReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateManureMethaneEmission(manureMethaneEmissionRate, numberOfSheep, numberOfDays);
    ...
    public void CalculateManureVolatilizationNitrogenEmissionReturnsCorrectValue()
    {
        ...
        var result = _resultsService.CalculateManureVolatilizationNitrogenEmission(
    ...
    public void CalculateManureLeachingNitrogemEmissionRateReturnsCorrectValue()
    {
        ...
        var result = _resultsService.CalculateManureLeachingNitrogemEmissionRate(nitrogenExcretionRate,
            leachingFraction,
    ...
    public void CalculateManureDirectNitrousOxideEmissionFromSheepReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateTotalManureDirectNitrousOxideEmissionFromSheep(
                manureDirectNitrogenEmissionFromSheep);
    ...
    public void CalculateManureIndirectNitrousOxideEmissionFromSheepReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateTotalManureIndirectNitrousOxideEmissionFromSheep(
                manureIndirectNitrogenEmissionFromSheep);
