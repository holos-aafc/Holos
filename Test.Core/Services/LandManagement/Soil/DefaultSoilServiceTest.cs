...
public class DefaultSoilServiceTest
{
    ...
    public void Test()
    {
        ...
        _mockGeographicDataProvider.Setup(x => x.GetGeographicalData(It.IsAny<int>())).Returns(new GeographicData
            { SoilDataForAllComponentsWithinPolygon = new List<SoilData> { new() } });
