...
public class PoultryResultsServiceTest
{
    ...
    public void CalculateEntericMethaneEmissionReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateEntericMethaneEmission(entericMethaneEmissionRate, numberOfPoultry,
                numberOfDaysInMonth);
    ...
    public void CalculateManureMethaneEmissionReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateManureMethaneEmission(manureMethaneEmissionRate, numberOfPoultry,
                numberOfDaysInMonth);
    ...
    public void CalculateTotalCarbonDioxideEmissionsFromPoultryOperationsReturnsCorrectValue()
    {
        ...
        var result = _resultsService.CalculateTotalEnergyCarbonDioxideEmissionsFromPoultryOperations(
            barnCapacityForPoultry,
