...
public class DairyCattleResultsServiceTest
{
    ...
    public void CalculateNetEnergyForActivityReturnsCorrectValue()
    {
        ...
        var result =
            _dairyCattleResultsService.CalculateNetEnergyForActivity(feedingActivityCoefficient,
    ...
    public void CalculateNetEnergyForGainReturnsCorrectValue()
    {
        ...
        var result = _dairyCattleResultsService.CalculateNetEnergyForGain(averageWeight, gainCoefficient,
            finalWeightOfMilkCow,
            averageDailyGain);
    ...
    public void CalculateGrossEnergyIntakeReturnsCorrectValue()
    {
        ...
        var result = _dairyCattleResultsService.CalculateGrossEnergyIntake(netEnergyForMaintenance,
    ...
    public void CalculateEntericMethaneEmissionRateReturnsCorrectValue()
    {
        ...
        var result = _dairyCattleResultsService.CalculateEntericMethaneEmissionRate(grossEnergyIntake,
    ...
    public void CalculateVolatileSolidsReturnsCorrectValue()
    {
        ...
        var result =
            _dairyCattleResultsService.CalculateVolatileSolids(grossEnergyIntake, percentDigestibleEnergyInFeed,
                ashContentOfFeed, 50);
    ...
    public void CalculateProteinIntakeReturnsCorrectValue()
    {
        ...
        var result =
            _dairyCattleResultsService.CalculateProteinIntake(grossEnergyIntake, conversionFactorForGrossEnergyIntake);
    ...
    public void CalculateNitrogenExcretionRateReturnsCorrectValue()
    {
        ...
        var result = _dairyCattleResultsService.CalculateNitrogenExcretionRate(proteinIntake,
            proteinRetainedForPregnancy,
    ...
    public void CalculateManureDirectNitrogenEmissionRateReturnsCorrectValue()
    {
        ...
        var result =
            _dairyCattleResultsService.CalculateManureDirectNitrogenEmissionRate(nitrogenExcretionRate, emissionFactor);
    ...
    public void CalculateManureDirectNitrogenEmissionReturnsCorrectValue()
    {
        ...
        var result =
            _dairyCattleResultsService.CalculateManureDirectNitrogenEmission(manureDirectNitrogenEmissionRate,
                numberOfCattle);
    ...
    public void CalculateManureVolatilizationNitrogenEmissionReturnsCorrectValue()
    {
        ...
        var result = _dairyCattleResultsService.CalculateManureVolatilizationNitrogenEmission(
            manureVolatilizationNitrogenEmissionRate,
            numberOfCattle);
    ...
    public void CalculateManureLeachingNitrogenEmissionRateReturnsCorrectValue()
    {
        ...
        var result = _dairyCattleResultsService.CalculateManureLeachingNitrogenEmissionRate(nitrogenExcretionRate,
            leachingFraction,
    ...
    public void CalculateManureLeachingNitrogenEmissionReturnsCorrectValue()
    {
        ...
        var result =
            _dairyCattleResultsService.CalculateManureLeachingNitrogenEmission(manureLeachingNitrogenEmissionRate,
                numberOfCattle);
    ...
    public void CalculateManureIndirectNitrogenEmissionReturnsCorrectValue()
    {
        ...
        var result = _dairyCattleResultsService.CalculateManureIndirectNitrogenEmission(
            manureVolatilizationNitrogenEmission,
    ...
    public void CalculateManureAvailableForLandApplicationReturnsCorrectValue()
    {
        ...
        var result = _dairyCattleResultsService.CalculateManureAvailableForLandApplication(nitrogenExcretionRate,
            numberOfCattle,
    ...
    public void CalculateTotalCarbonDioxideEmissionsFromDairyOperationsReturnsCorrectValue()
    {
        ...
        var result = _dairyCattleResultsService.CalculateTotalCarbonDioxideEmissionsFromDairyHousing(
            numberOfLactatingDairyCows,
            numberOfDaysInMonth, electricityConversion);
        Assert.AreEqual(
            numberOfLactatingDairyCows * (dairyCowConversion / CoreConstants.DaysInYear) * numberOfDaysInMonth *
            electricityConversion, result);
    }
