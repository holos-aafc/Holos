...
public partial class FieldResultsServiceTest : UnitTestBase
{
    ...
    public void UpdatePercentageReturnsForPerennialsSetReturnTo100PercentWhenYieldIs0()
    {
        ...
        {
            new() { CropType = CropType.TameGrass, PercentageOfProductYieldReturnedToSoil = 35, Yield = 0 },
            new() { CropType = CropType.TameLegume, PercentageOfProductYieldReturnedToSoil = 35, Yield = 1000 },
            new() { CropType = CropType.Barley, PercentageOfProductYieldReturnedToSoil = 2 }
        };
    ...
    public void AssignPerennialStandIds()
    {
        var crops = new List<CropViewItem>
        {
            new() { CropType = CropType.TameLegume, Year = 2000 },
            new() { CropType = CropType.TameLegume, Year = 2000, IsSecondaryCrop = true },
            new() { CropType = CropType.TameLegume, Year = 2001 },
            new() { CropType = CropType.TameLegume, Year = 2001, IsSecondaryCrop = true },
            new() { CropType = CropType.ForageForSeed, Year = 2002 },
            new() { CropType = CropType.ForageForSeed, Year = 2002, IsSecondaryCrop = true },
            new() { CropType = CropType.ForageForSeed, Year = 2003 },
            new() { CropType = CropType.ForageForSeed, Year = 2003, IsSecondaryCrop = true },
            new() { CropType = CropType.Barley, Year = 2004 },
            new() { CropType = CropType.None, Year = 2004, IsSecondaryCrop = true },
            new() { CropType = CropType.TameMixed, Year = 2005 },
            new() { CropType = CropType.TameMixed, Year = 2005, IsSecondaryCrop = true },
            new() { CropType = CropType.TameMixed, Year = 2006 },
            new() { CropType = CropType.TameMixed, Year = 2006, IsSecondaryCrop = true }
        };
    ...
    public void AssignPerennialStandIdsAppliesCorrectIdsWhenUndersownCropsUsed()
    {
        ...
        var crops = new List<CropViewItem>
        {
            new() { CropType = CropType.Lentils, Year = 2000 },
            new() { CropType = CropType.TameGrass, Year = 2000, UnderSownCropsUsed = true, IsSecondaryCrop = true },
            new() { CropType = CropType.TameGrass, Year = 2001 },
            new() { CropType = CropType.None, Year = 2001, IsSecondaryCrop = true },
            new() { CropType = CropType.Lentils, Year = 2002 },
            new() { CropType = CropType.TameGrass, Year = 2002, UnderSownCropsUsed = true, IsSecondaryCrop = true },
            new() { CropType = CropType.TameGrass, Year = 2003 },
            new() { CropType = CropType.None, Year = 2003, IsSecondaryCrop = true }
        };
    ...
    public void AssignPerennialStandIdsConsidersCoverCrop()
    {
        var crops = new List<CropViewItem>
        {
            new() { CropType = CropType.Lentils, Year = 2019 }, // Main crop grown
            new()
            {
                CropType = CropType.AlfalfaMedicagoSativaL, Year = 2019, IsSecondaryCrop = true
            }, // Cover crop used in same year
            new() { CropType = CropType.TameLegume, Year = 2020 },
            new() { CropType = CropType.None, Year = 2020, IsSecondaryCrop = true }
        };
    ...
    public void AssignPerennialStandIdsConsidersOnlyPerennials()
    {
        var crops = new List<CropViewItem>
        {
            new() { CropType = CropType.Lentils, Year = 2019 }
        };
    ...
    public void AssignPerennialStandPositionalYears()
    {
        ...
        var crops = new List<CropViewItem>
        {
            new() { CropType = CropType.Wheat, Year = 2019, PerennialStandGroupId = guid },
            new() { CropType = CropType.TameLegume, Year = 2019, IsSecondaryCrop = true, PerennialStandGroupId = guid },
            new() { CropType = CropType.TameLegume, Year = 2020, PerennialStandGroupId = guid },
            new() { CropType = CropType.TameLegume, Year = 2020, IsSecondaryCrop = true, PerennialStandGroupId = guid },
            new() { CropType = CropType.TameLegume, Year = 2021, PerennialStandGroupId = guid }
        };
        ...
        var farm = new Farm
        {
            ...
            Components = new ObservableCollection<ComponentBase>
            {
                new FieldSystemComponent
                {
                    ...
                    {
                        new() { CropType = CropType.Barley, Year = 2021 },
                        new() { CropType = CropType.Oats, Year = 2020 }
                    }
                }
            }
        };
    ...
    public void CalculateTotalCarbonDioxideEmissionsFromIrrigationReturnsCorrectValueElectricPump()
    {
        ...
        var carboxDioxideEmission = _resultsService.CalculateTotalCarbonDioxideEmissionsFromIrrigation(
            areaOfCropIrrigated,
            irrigationConversion,
            farm.Defaults.PumpEmissionFactor);
        var result = Math.Round(carboxDioxideEmission, 2);
    ...
    public void CalculateCarbonDioxideEmissionsFromCroppingEnergyUseCorrectValue()
    {
        ...
        var truncResult = Math.Round(result, 2);
    ...
    public void AssignCarbonInputsSetsCarbonInputWhenThereIsMissingYieldDataForFirstYear()
    {
        ...
        var component = new FieldSystemComponent
            { CropViewItems = new ObservableCollection<CropViewItem>(orderedViewItems) };
    ...
    public void AssignCarbonInputsWhenACoverCropIsUsed()
    {
        ...
        {
            new() { CropType = CropType.Lentils, Year = 2000 },
            new() { CropType = CropType.AlfalfaMedicagoSativaL, Year = 2000 }
        };
    ...
    public void AssignCarbonInputsUsingTier2StrategySetsInputs()
    {
        ...
        var component = new FieldSystemComponent
            { CropViewItems = new ObservableCollection<CropViewItem>(orderedViewItems), Guid = guid };
    ...
    public void MergeDetailViewItems()
    {
        var viewItems = new List<CropViewItem>
        {
            new() { Year = 2000, CropType = CropType.Lentils },
            new() { Year = 2000, CropType = CropType.AlfalfaMedicagoSativaL }
        };
    ...
    public void MergeDetailViewItemsForSingleItemWithFollowingYearViewItem()
    {
        ...
        {
            new() { Year = 2000, CropType = CropType.Lentils },
            new() { Year = 2001, CropType = CropType.AlfalfaMedicagoSativaL }
        };
    ...
    public void CombineInputsForAllCropsInSameYear()
    {
        ...
        {
            Name = "Main crop", CropType = CropType.Barley, Year = 2000, AboveGroundCarbonInput = 200,
            BelowGroundCarbonInput = 50
        };
        var viewItem2 = new CropViewItem
        {
            Name = "Undersown crop", CropType = CropType.TameGrass, Year = 2000, AboveGroundCarbonInput = 100,
            BelowGroundCarbonInput = 75, IsSecondaryCrop = true
        };

        // Inputs from this item should not be considered because it is for the following year
        var viewItem3 = new CropViewItem
        {
            Name = "Main crop for following year", CropType = CropType.TameGrass, Year = 2001,
            AboveGroundCarbonInput = 1000, BelowGroundCarbonInput = 2000
        };

        // Inputs from this item should not be considered because it is for the previous year
        var viewItem4 = new CropViewItem
        {
            Name = "Main crop for previous year", CropType = CropType.TameGrass, Year = 1999,
            AboveGroundCarbonInput = 1000, BelowGroundCarbonInput = 2000
        };
        ...
        _resultsService.CombineInputsForAllCropsInSameYear(GetTestFarm(), viewItems);
    ...
    public void CreateOrderedViewItemsReturnsCorrectOrderingWhenUserSelectsToOrderFromStartYear()
    {
        var viewItems = new List<CropViewItem>
        {
            new() { CropType = CropType.Oats, Year = 1989 },
            new() { CropType = CropType.Wheat, Year = 1990 }
        };
        ...
        var result = _resultsService.CreateOrderedViewItems(component, viewItems,
            new Farm { Defaults = new Defaults { CarbonModellingStrategy = CarbonModellingStrategies.ICBM } });
    ...
    public void CreateOrderedViewItemsReturnsCorrectOrderingWhenUserSelectsToOrderFromEndYear()
    {
        var viewItems = new List<CropViewItem>
        {
            new() { CropType = CropType.Oats, Year = 1990 },
            new() { CropType = CropType.Wheat, Year = 1989 }
        };
    ...
    public void CreateOrderedViewItemsBeginningFromStartYearForAnnualCrops()
    {
        ...
        var viewItems = new List<CropViewItem>
        {
            new() { CropType = CropType.Lentils, Year = 1989 },
            new() { CropType = CropType.Oats, Year = 1990 }
        };

        var result = _resultsService.CreateOrderedViewItems(fieldSystemComponent, viewItems,
            new Farm { Defaults = new Defaults { CarbonModellingStrategy = CarbonModellingStrategies.ICBM } });
    ...
    public void CreateOrderedViewItemsBeginningFromStartYearForUndersownCrops()
    {
        ...
        var viewItems = new List<CropViewItem>
        {
            new() { CropType = CropType.Barley, Year = 2000 },
            new() { CropType = CropType.TameGrass, Year = 2000 },
            new() { CropType = CropType.TameGrass, Year = 2001 },
            new() { CropType = CropType.TameGrass, Year = 2002 }
        };
    ...
    public void AssignUndersownCropViewItemsDescriptionSetsDescriptionForUndersownYearOnly()
    {
        var viewItem1 = new CropViewItem
        {
            CropType = CropType.TameMixed, YearInPerennialStand = 1, UnderSownCropsUsed = true, IsSecondaryCrop = true
        };
        var viewItem2 = new CropViewItem
        {
            CropType = CropType.TameMixed, YearInPerennialStand = 2, UnderSownCropsUsed = true, IsSecondaryCrop = true
        };
    ...
    public void PreProcessViewItemsConsidersMultipleUndersownSequences()
    {
        var fieldSystemComponent = new FieldSystemComponent
        {
            CropViewItems = new ObservableCollection<CropViewItem>
            {
                ...
                new() { CropType = CropType.Lentils, Year = 2002 },
                new() { CropType = CropType.TameMixed, Year = 2003 }
            },

            CoverCrops = new ObservableCollection<CropViewItem>
            {
                new() { CropType = CropType.TameGrass, Year = 2000 }, // Hay grass is undersown into the barley
                new() { CropType = CropType.TameMixed, Year = 2002 } // Hay mixed is undersown into the lentils
            }
        };
    ...
    public void CreateItemsForCoverCrops()
    {
        ...
        var result = _resultsService.CreateItems(fieldSystemComponent,
            new Farm { Defaults = new Defaults { CarbonModellingStrategy = CarbonModellingStrategies.ICBM } });
    ...
    public void GetAdjoiningYearsForPerennials()
    {
        ...
        var viewItems = new List<CropViewItem>
        {
            ...
            new()
            {
                CropType = CropType.TameGrass, Year = 2000, UnderSownCropsUsed = true, PerennialStandGroupId = standId
            },

            new() { CropType = CropType.TameGrass, Year = 2001, PerennialStandGroupId = standId },
            new() { CropType = CropType.TameGrass, Year = 2002, PerennialStandGroupId = standId }
        };
    ...
    public void GetAdjoiningYearsForAnnuals()
    {
        ...
        {
            new() { CropType = CropType.Lentils, Year = 2000 },
            new() { CropType = CropType.Lentils, Year = 2001 },
            new() { CropType = CropType.Lentils, Year = 2002 }
        };
    ...
    public void CreateDetailViewItemsAddsMainCropsToStageState()
    {
        ...
        var mainCrops = new List<CropViewItem> { new() };
    ...
    public void GetRunInItems()
    {
        ...
        {
            new() { CropType = CropType.Barley },
            new() { CropType = CropType.Wheat },
            new() { CropType = CropType.TameGrass },
            new() { CropType = CropType.TameGrass }
        };

        var viewItemsForField = new List<CropViewItem>
        {
            new() { CropType = CropType.Barley, Year = startYear + 0 },
            new() { CropType = CropType.Wheat, Year = startYear + 1 },
            new() { CropType = CropType.TameGrass, Year = startYear + 2 },
            new() { CropType = CropType.TameGrass, Year = startYear + 3 }
        };
        ...
        var items = _resultsService.GetRunInPeriodItems(
            ...
            viewItemsInRotation,
            startYear,
            viewItemsForField, new FieldSystemComponent());
    ...
    public void CalculateCarbonUptakeByGrazingAnimals()
    {
        ...
        var managementPeriod = GetTestManagementPeriod();
        ...
        var animalResults = new AnimalGroupEmissionResults
        {
            ...
            {
                new(new MonthsAndDaysData { ManagementPeriod = managementPeriod },
        ...
        _mockAnimalResultsService.Setup(x => x.GetResultsForManagementPeriod(It.IsAny<AnimalGroup>(), It.IsAny<Farm>(),
            It.IsAny<AnimalComponentBase>(), It.IsAny<ManagementPeriod>())).Returns(animalResults);
        _resultsService.AnimalResultsService = _mockAnimalResultsService.Object;
        carbonService.CalculateCarbonLostByGrazingAnimals(farm, fieldSystemComponent, animalComponentEmissionsResults,
            new List<CropViewItem> { cropViewItem });
    ...
    public void CalculateAmmoniaEmissionFromLandAppliedManureForPoultry()
    {
        ...
        animalComponentResults.EmissionResultsForAllAnimalGroupsInComponent =
            new List<AnimalGroupEmissionResults> { new() };
        ...
        var groupEmissionsByMonth =
            new GroupEmissionsByMonth(new MonthsAndDaysData(), new List<GroupEmissionsByDay> { dailyEmissions });
    ...
    public void PostProcessPerennialsTest()
    {
        ...
        var viewItem1 = new CropViewItem
        {
            FieldSystemComponentGuid = field.Guid, CropType = CropType.TameGrass, YearInPerennialStand = 1,
            PerennialStandLength = 2, Year = 2000
        };
        var viewItem2 = new CropViewItem
        {
            FieldSystemComponentGuid = field.Guid, CropType = CropType.TameGrass, YearInPerennialStand = 2,
            PerennialStandLength = 2, Year = 2001, PercentageOfRootsReturnedToSoil = 100
        };
        var viewItem3 = new CropViewItem
        {
            FieldSystemComponentGuid = field.Guid, CropType = CropType.RangelandNative, YearInPerennialStand = 1,
            PerennialStandLength = 2, Year = 2002
        };
        var viewItem4 = new CropViewItem
        {
            FieldSystemComponentGuid = field.Guid, CropType = CropType.RangelandNative, YearInPerennialStand = 1,
            PerennialStandLength = 2, Year = 2003, PercentageOfRootsReturnedToSoil = 1
        };

        stageState.DetailsScreenViewCropViewItems.AddRange(new List<CropViewItem>
            { viewItem1, viewItem2, viewItem3, viewItem4 });
