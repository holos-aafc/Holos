...
public class AnaerobicDigestionComponentHelperTest
{
    ...
    public void TestReplicateSingleManagementPeriodViewItems()
    {
        ...
        Assert.IsTrue(result.AnaerobicDigestionViewItem.ManureSubstrateViewItems[0].ManureStateType
        ...
        Assert.IsTrue(result.AnaerobicDigestionViewItem.CropResiduesSubstrateViewItems[0].CropType
            .Equals(CropType.Barley));

        Assert.IsTrue(result.AnaerobicDigestionViewItem.FarmResiduesSubstrateViewItems[0].FlowRate.Equals(11));
        Assert.IsTrue(result.AnaerobicDigestionViewItem.FarmResiduesSubstrateViewItems[0].FarmResidueType
            .Equals(FarmResidueType.FoodWaste));
    }
