...
public class InitializationServiceTest
{
    ...
    public void CalculateAmountOfProductRequired()
    {
        ...
        var result =
            _initializationService.CalculateAmountOfProductRequired(farm, viewItem, fertilizerApplicationViewItem);
    ...
    public void InitializeDefaultEmissionFactorsUpdatesDefault()
    {
        ...
        Assert.AreEqual(0.02, managementPeriod.ManureDetails.MethaneConversionFactor);
    }
    ...
    public void InitializeManureMineralizationFractionsUpdatedDefaultValues()
    {
        ...
        Assert.AreEqual(0.25, managementPeriod.ManureDetails.FractionOfOrganicNitrogenNitrified);
    }
    ...
    public void InitializeManureCompositionDataAssignsNewValueToManureDetails()
    {
        ...
        Assert.AreEqual(20, managementPeriod.ManureDetails.FractionOfPhosphorusInManure);
    }
    ...
    public void ReinitializeFuelEnergyUpdatesDefaultTwoArguments()
    {
        ...
        Assert.AreEqual(1.78, viewItem.FuelEnergy);
    }
    ...
    public void ReinitializeHerbicideEnergyUpdatesDefaultTwoArguments()
    {
        ...
        Assert.AreEqual(0.06, viewItem.HerbicideEnergy);
    }
    ...
    public void ReinitializeHerbicideEnergyUpdatesDefaultSingleArgument()
    {
        ...
        var cropViewItemsPostInitialization = _farm1.GetCropDetailViewItems();
        Assert.AreEqual(0.06, cropViewItemsPostInitialization[0].HerbicideEnergy);
    }
    ...
    public void ReinitializeHerbicideEnergyUpdatesDefaultSingleArgumentMultipleCropViewItems()
    {
        ...
        var cropViewItemsPostInitialization = _farm1.GetCropDetailViewItems();
        Assert.AreEqual(0.24, cropViewItemsPostInitialization[0].HerbicideEnergy);
        Assert.AreEqual(0.12, cropViewItemsPostInitialization[1].HerbicideEnergy);
        Assert.AreEqual(0, cropViewItemsPostInitialization[2].HerbicideEnergy);
    }
    ...
    public void InitializeSwineVsExcretionForDietsDefaultValue()
    {
        ...
        Assert.AreEqual(0.1228, managementPeriod.ManureDetails.VolatileSolidExcretion);
    }
    ...
    public void InitializeSwineVsExcretionForDietsDefaultValueMultipleSwineTypes()
    {
        ...
        _initializationService.InitializeVolatileSolidsExcretion(_farm1);
        Assert.AreEqual(0.1228, managementPeriodOne.ManureDetails.VolatileSolidExcretion);
        Assert.AreEqual(0.1389, managementPeriodTwo.ManureDetails.VolatileSolidExcretion);
        Assert.AreEqual(0.1504, managementPeriodThree.ManureDetails.VolatileSolidExcretion);
    }
    ...
    public void InitializeIrrigationWaterApplicationTwoArguments()
    {
        ...
        Assert.AreEqual(7, cropViewItemOne.AmountOfIrrigation);
        Assert.AreEqual(96.93, cropViewItemOne.GrowingSeasonIrrigation, 0.01);
        Assert.AreEqual(7, cropViewItemTwo.AmountOfIrrigation);
        Assert.AreEqual(96.93, cropViewItemTwo.GrowingSeasonIrrigation, 0.01);
    }
    ...
    public void InitializeIrrigationWaterApplicationSingleArgument()
    {
        ...
        Assert.AreEqual(7, cropViewItem.AmountOfIrrigation);
        Assert.AreEqual(96.18, cropViewItem.GrowingSeasonIrrigation, 0.01);
    }
    ...
    public void InitializeIrrigationWaterApplicationLessTranspiration()
    {
        ...
        Assert.AreEqual(0, cropViewItem.AmountOfIrrigation);
    }
    ...
    public void InitializeOtherLivestockCh4EmissionFactorNullArguments()
    {
        ...
        try
        {
            _initializationService
                .InitializeDailyManureMethaneEmissionRate(farm); // passing farm with null dairyComponent
        }
        catch (Exception ex)
        {
            Assert.Fail(ex.Message);
    ...
    public void InitializeDefaultMoistureContent()
    {
        var stageState = new FieldSystemDetailsStageState
        {
            ...
            {
                new() { HarvestMethod = HarvestMethods.Silage },
                new() { HarvestMethod = HarvestMethods.GreenManure },
                new() { HarvestMethod = HarvestMethods.Swathing },
                new() { CropType = CropType.SilageCorn }
            }
        };
        var farm = new Farm();
        farm.StageStates.Add(stageState);
        _initializationService.InitializeMoistureContent(farm);
        foreach (var item in farm.StageStates.OfType<FieldSystemDetailsStageState>().First()
                     .DetailsScreenViewCropViewItems) Assert.AreEqual(65, item.MoistureContentOfCropPercentage);
    }
    ...
    public void InitializeCarbonConcentrationSingleArgument()
    {
        ...
        Assert.AreEqual(0.45, cropViewItem.CarbonConcentration);
    }
    ...
    public void InitializeNitrogenFixationNonLegumousCrop()
    {
        ...
        Assert.AreEqual(0, viewItem.NitrogenFixationPercentage);
    }
    ...
    public void InitializeNitrogenFixationLegumousCrop()
    {
        ...
        _initializationService.InitializeNitrogenFixation(viewItem);
        Assert.AreEqual(70, viewItem.NitrogenFixationPercentage);
    }
    ...
    public void InitializeNitrogenFixationFarmArgumentTwoCropViewItems()
    {
        ...
        Assert.AreEqual(0, cropViewItemOne.NitrogenFixationPercentage);
        Assert.AreEqual(70, cropViewItemTwo.NitrogenFixationPercentage);
    }
