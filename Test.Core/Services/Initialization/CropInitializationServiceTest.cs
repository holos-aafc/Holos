...
public class CropInitializationServiceTest : UnitTestBase
{
    ...
    public void InitializeAvailableSoilTypesDoesNotAddOrganicType()
    {
        ...
        _farm.GeographicData = GetTestGeographicData();
    ...
    public void InitializeManureApplicationMethodForBeefCattleTypes()
    {
        ...
        var manureApplication = GetTestDairyCattleManureApplicationViewItemUsingImportedManure();
        ...
        _cropsInitializationService.InitializeManureApplicationMethod(viewItem, manureApplication,
        ...
        Assert.AreEqual(ManureApplicationTypes.UntilledLandSolidSpread,
            manureApplication.AvailableManureApplicationTypes[0]);
        Assert.AreEqual(ManureApplicationTypes.TilledLandSolidSpread,
            manureApplication.AvailableManureApplicationTypes[1]);
    }
    ...
    {
        var viewItem = GetTestCropViewItem();
        var fertilizerApplication = GetTestFertilizerApplicationViewItem();

        _cropsInitializationService.InitializeFertilizerApplicationMethod(viewItem, fertilizerApplication);

        Assert.AreEqual(FertilizerApplicationMethodologies.IncorporatedOrPartiallyInjected,
            fertilizerApplication.FertilizerApplicationMethodology);
    }
    ...
    public void InitializeFertilizerApplicationMethodForPerennials()
    {
        ...
        Assert.AreEqual(FertilizerApplicationMethodologies.Broadcast,
            fertilizerApplication.FertilizerApplicationMethodology);
    }
