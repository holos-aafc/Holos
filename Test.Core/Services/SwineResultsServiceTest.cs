...
public class SwineResultsServiceTest
{
    ...
    public void CalculateEntericMethaneEmissionReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateEntericMethaneEmissionForSwinePoultryAndOtherLivestock(entericMethaneEmissionRate,
                numberOfPigs);
    ...
    public void CalculateVolatileSolidAdjustedReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateVolatileSolidAdjusted(volatileSolidExcretion, volatileSolidAdjustmentFactor);
    ...
    public void CalculateManureMethaneEmissionReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateManureMethaneEmission(manureMethaneEmissionRate, numberOfPigs, numberOfDays);
    ...
    public void CalculateNitrogenExcretionRateReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateNitrogenExcretionRate(proteinIntake, proteinRetained,
                nitrogenExcretedAdjustmentFactor);
    ...
    public void CalculateManureDirectNitrogenEmissionReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateManureDirectNitrogenEmission(manureDirectNitrogenEmissionRate, numberOfPigs);
    ...
    public void CalculateManureLeachingNitrogenEmissionRateReturnsCorrectValue()
    {
        ...
        var result = _resultsService.CalculateManureLeachingNitrogenEmissionRate(nitrogenExcretionRate,
            leachingFraction,
    ...
    public void CalculateTotalManureDirectN2OEmissionFromSwineReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateTotalManureDirectN2OEmissionFromSwine(manureDirectNitrogenEmissionFromSwine);
