...
public class BeefCattleResultsServiceTest
{
    ...
    public void CalculateMaintenanceCoefficientReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateTemperatureAdjustedMaintenanceCoefficient(baselineMaintenanceCoefficient,
    ...
    public void CalculateNetEnergyForLactationReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateNetEnergyForLactation(milkProduction, fatContent, numberOfCalves, numberOfCows);
    ...
    public void CalculateCalfProteinIntakeReturnsCorrectValue()
    {
        ...
        var result =
            _resultsService.CalculateCalfProteinIntake(calfProteinIntakeFromMilk, calfProteinIntakeFromSolidFood, true);
    ...
    public void CalculateTotalCarbonDioxideEmissionsFromHousedBeefOperationsReturnsCorrectValue()
    {
        ...
        Assert.AreEqual(
            numberOfCattle * (housedBeefConversion / CoreConstants.DaysInYear) * numberOfDaysInMonth *
