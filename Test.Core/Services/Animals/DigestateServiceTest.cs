...
public class DigestateServiceTest : UnitTestBase
{
    ...
    public void TestInitialize()
    {
        ...
        _mockAdCalculator
            ...
            .Returns(new List<DigestorDailyOutput>(_dailyResults));
        ...
        _farm = GetTestFarm();
        var fieldComponent = GetTestFieldComponent();
        _cropViewItem = GetTestCropViewItem();
        _livestockDigestateApplication = GetTestRawDigestateApplicationViewItem();
        ...
        _importedDigestateApplication = GetTestRawDigestateApplicationViewItem();
        ...
        _adComponent = GetTestAnaerobicDigestionComponent();
    ...
    public void GetTotalCarbonRemainingAtEndOfYear()
    {
        ...
        _sut.Initialize(_farm,
            new List<AnimalComponentEmissionsResults> { GetNonEmptyTestBeefCattleAnimalComponentEmissionsResults() });
    ...
    {
        var result = _sut.GetTotalAmountOfDigestateAppliedOnDay(_livestockDigestateApplication.DateCreated.Date, _farm,
            _state, ManureLocationSourceType.Livestock);
    ...
    public void GetTotalManureNitrogenRemainingForFarmAndYearReturnsRawAmountsNotConsideringLandAppliedAmountsTest()
    {
        _adComponent.IsLiquidSolidSeparated = false;
        var result =
            _sut.GetTotalManureNitrogenRemainingForFarmAndYear(DateTime.Now.Year, _farm, _dailyResults,
                DigestateState.Raw);
    ...
    public void GetTotalManureNitrogenRemainingForFarmAndYearReturnsLiquidAmountsNotConsideringLandAppliedAmountsTest()
    {
        ...
        _adComponent.IsLiquidSolidSeparated = true;
        var result = _sut.GetTotalManureNitrogenRemainingForFarmAndYear(DateTime.Now.Year, _farm, _dailyResults,
            DigestateState.LiquidPhase);
    ...
    [TestMethod]
    public void
        GetTotalManureNitrogenRemainingForFarmAndYearReturnsLiquidAmountsConsideringImportedLandAppliedAmountsTest()
    {
