...
public class ScaleUpServiceTest
{
    ...
    {
        var result = _scaleUpService.ShouldScaleUp(true, AnimalType.BeefBackgrounderHeifer,
            ProductionStages.GrowingAndFinishing, ComponentType.Backgrounding,
            new Farm { Defaults = new Defaults { ScaleUpEmissionsEnabled = true } });
    ...
    {
        var result = _scaleUpService.ShouldScaleUp(true, AnimalType.BeefCowLactating, ProductionStages.Lactating,
            ComponentType.CowCalf, new Farm { Defaults = new Defaults { ScaleUpEmissionsEnabled = true } });
