    ...
    public class SoilResultsViewModel : ResultsViewModelBase
    {
        ...
        private void OnExportToCsv(object obj)
        {
            ...
            try
            {
                ...
                if (Storage.ApplicationData.PrototypeStorage.ShowSingleCoordinateResults)
                {
        ...
        private async void AddViewItemsAsync()
        {
            ...
            try
            {
                ...
                {
                    Storage.ApplicationData.PrototypeStorage.SingleSoilViewItem
                };
                ...
                else
                {
                    if (Storage.ApplicationData.PrototypeStorage.SoilViewItems != null)
                        await AddViewItemsToCollection(cancellationToken, Storage.ApplicationData.PrototypeStorage.SoilViewItems, SoilResultsViewItems);
                }
            }
