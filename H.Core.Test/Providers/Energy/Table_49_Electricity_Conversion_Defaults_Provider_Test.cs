...
namespace H.Core.Test.Providers.Energy
{
    ...
    public class Table_49_Electricity_Conversion_Defaults_Provider_Test
    {
        ...
        {
            Table_49_Electricity_Conversion_Defaults_Data data = _provider.GetElectricityConversionData(1994, Province.Alberta);
        ...
        {
            Table_49_Electricity_Conversion_Defaults_Data data = _provider.GetElectricityConversionData(2075, Province.PrinceEdwardIsland);
        ...
        {
            Table_49_Electricity_Conversion_Defaults_Data data = _provider.GetElectricityConversionData(1994, Province.Yukon);
            Assert.AreEqual(0, data.ElectricityValue);
        }
        ...
        {
            Table_49_Electricity_Conversion_Defaults_Data data = _provider.GetElectricityConversionData(2075, Province.Yukon);
            Assert.AreEqual(0, data.ElectricityValue);
        }
