...
namespace H.Core.Test.Providers.Energy
{
    ...
    public class Table_50_Fuel_Energy_Estimates_Provider_Test
    {
        ...
        {
            Table_50_Fuel_Energy_Estimates_Data data = _provider.GetFuelEnergyEstimatesDataInstance(Province.Alberta, SoilFunctionalCategory.Black, TillageType.NoTill, CropType.CanarySeed);
        ...
        {
            Table_50_Fuel_Energy_Estimates_Data data = _provider.GetFuelEnergyEstimatesDataInstance(Province.Ontario, SoilFunctionalCategory.EasternCanada, TillageType.Reduced, CropType.WinterTurnipRapeBrassicaRapaSppOleiferaLCVLargo);
        ...
        {
            Table_50_Fuel_Energy_Estimates_Data data = _provider.GetFuelEnergyEstimatesDataInstance(Province.BritishColumbia, SoilFunctionalCategory.Brown, TillageType.NoTill, CropType.ForageForSeed);
        ...
        {
            Table_50_Fuel_Energy_Estimates_Data data = _provider.GetFuelEnergyEstimatesDataInstance(Province.Newfoundland, SoilFunctionalCategory.EasternCanada, TillageType.Intensive, CropType.Chickpeas);
        ...
        {
            Table_50_Fuel_Energy_Estimates_Data data = _provider.GetFuelEnergyEstimatesDataInstance(Province.Yukon, SoilFunctionalCategory.Brown, TillageType.NoTill, CropType.ForageForSeed);
        ...
        {
            Table_50_Fuel_Energy_Estimates_Data data = _provider.GetFuelEnergyEstimatesDataInstance(Province.Newfoundland, SoilFunctionalCategory.Organic, TillageType.NoTill, CropType.Durum);
            Assert.AreEqual(0, data.FuelEstimate);
        }
        ...
        {
            Table_50_Fuel_Energy_Estimates_Data data = _provider.GetFuelEnergyEstimatesDataInstance(Province.Newfoundland, SoilFunctionalCategory.EasternCanada, TillageType.NoTill, CropType.LargeKabuliChickpea);
            Assert.AreEqual(0, data.FuelEstimate);
        }
        #endregion
        ...
        {
            Table_50_Fuel_Energy_Estimates_Data data = _provider.GetFuelEnergyEstimatesDataInstance(Province.NewBrunswick, SoilFunctionalCategory.EasternCanada, TillageType.NoTill, CropType.Potatoes);
