...
namespace H.Core.Test.Providers.Climate
{
    ...
    public class Table_54_Global_Warming_Emissions_Potential_Provider_Test
    {
        ...
        {
            Table_54_Global_Warming_Emissions_Potential_Data data = _provider.GetGlobalWarmingEmissionsInstance(1990, EmissionTypes.CH4);
        ...
        {
            Table_54_Global_Warming_Emissions_Potential_Data data = _provider.GetGlobalWarmingEmissionsInstance(1995, EmissionTypes.CO2e);
        ...
        {
            Table_54_Global_Warming_Emissions_Potential_Data data = _provider.GetGlobalWarmingEmissionsInstance(2035, EmissionTypes.N2O);
            Assert.AreEqual(0, data.GlobalWarmingPotentialValue);
        }
        ...
        {
            Table_54_Global_Warming_Emissions_Potential_Data data = _provider.GetGlobalWarmingEmissionsInstance(2014, EmissionTypes.LivestockDirectN20);
            Assert.AreEqual(0, data.GlobalWarmingPotentialValue);
        }
        ...
        {
            Table_54_Global_Warming_Emissions_Potential_Data data = _provider.GetGlobalWarmingEmissionsInstance(2013, EmissionTypes.N2O);
