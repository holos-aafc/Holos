...
namespace H.Core.Test.Providers.Animals
{
    ...
    public class Table_22_Livestock_Coefficients_Sheep_Provider_Test
    {
        ...
        {
            _provider = new Table_22_Livestock_Coefficients_Sheep_Provider();
        }

        [TestMethod]
        public void GetDataByManureStorageType()
        {
            var result = _provider.GetCoefficientsByAnimalType(AnimalType.Ram) as Table_22_Livestock_Coefficients_Sheep_Data;
