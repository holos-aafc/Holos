...
{
    /// <summary>
    /// Summary description for ExpressionOfUncertaintyCalculatorTest
    /// </summary>
    [TestClass]
    public class ExpressionOfUncertaintyCalculatorTest
    {
        private ExpressionOfUncertaintyCalculator calc;
        ...
        {
            calc = new ExpressionOfUncertaintyCalculator();
        }
