...
For the purpose of this training, we are going to create a farm that has a Farrow-to-Wean and a Grower-to-Finish production system. We will also create a field component to 'grow' crops on our farm. The farm is located in Manitoba near Portage La Prairie.
...
If we click on the drop-down button next to a category's name, we can see the available components in that category.  For this portion of the training section, we will be working with the “Land management” and “Swine” categories. 
...
1. Drag a new **Field** component to your list of components. Enter the name **"Native Grassland"** as the field name.
...
4. Enter data related to the number of animals, diet, manure system, and housing type in **Step 3**. On the **General** Tab:
...
5. On the **Diet Tab** select **"Gestation"** from the diet drop down menu. From the **Housing Tab** select **"Housed in Barn"** and set the bedding type as **"Straw (Chopped)"** (keep the default application rate). From the **Manure Tab** select **"Liquid/Slurry with natural crust"**.
...
8. On the **Diet Tab** select **"Gestation"** from the diet drop down menu. From the **Housing Tab** select **"Housed in Barn"** with **"Straw (Chopped)"** bedding (keep the default application rate), and from the **Manure Tab** select **"Liquid/Slurry with natural crust"**.
...
3. Enter data related to the number of animals, diet, manure system, and housing type in **Step 3**. On the **General** Tab:
    * Select **"Open (not lactating or pregnant)"** as the production stage.
    * Enter **"83"** as the number of animals.
    * Enter **"9"** for the litter size, **"1.4"** kg for the weight of piglets at birth and **"6"** kg for the weight of weaned piglets.
    * For all other fields keep the default values.

4. On the **Diet Tab** select **"Gestation"** from the diet drop down menu. On the **Housing Tab**, select **"Housed in Barn"** and set the bedding type as **"Straw (Chopped)"** (keep the default application rate). From the **Manure Tab** select **"Liquid/Slurry with natural crust"**.
...
6. On the **General** tab for all three **"Bred Sows"** management periods:
    * Select **"Gestating"** as the production stage.
    * Enter **"83"** as the number of animals.
    * Enter **"9"** kg for the litter size, **"1.4"** kg for the weight of piglets at birth and **"6"** for the weight of weaned piglets
    * For all other fields keep the default values.  
    
7. On the **Diet Tab** select **"Gestation"** from the diet drop down menu. From the **Housing Tab** select **"Housed in Barn"** with **"Straw (Chopped)"** bedding (keep the default application rate), and on the **Manure Tab** select **"Liquid/Slurry with natural crust"**.

8. Moving to the **"Farrowing lactating sows"** management period in **Step 2**, set the start date to **"May 3, 2024"** and the end date to **"June 24, 2024"** (21 days).

9. On the **General** tab, select **"Lactating"** as the production stage and enter **"83"** as the number of animals. For all other fields keep the default values.
    
10. On the **Diet Tab** select **"Lactation"** from the diet drop down menu. From the **Housing Tab** select **"Housed in Barn"** with **"Straw (Chopped)"** bedding (keep the default application rate), and from the **Manure Tab** select **"Liquid/Slurry with natural crust"**.
...
2. For this animal group, we will create a custom diet.
    
#### **Creating a New Diet**

As an alternative to the default set of standard animal diets that are found in Holos, users can create custom diets. *(Note: Holos incorporates feed ingredient information from D. Beaulieu, University of Saskatchewan, for default swine diets.)* 
...
1. Click the **Add Custom Diet** button under **Step 1** to begin to create our new custom diet.
2. Rename the diet **"Custom Boar Diet"** and press Enter to save.
3. Add ingredients to the new diet in **Step 2**. Select **Add Selected Ingredients to Diet**. Search for **"Wheat, Hard Red"** from the ingredient list, highlight the choice, and then click the **OK** button below to have it appear in **Step 3**.
4. Enter the **Percentage in diet (%DM)** value for this ingredient; here we will input **"38%"**.
5. Continue to add more ingredients to the diet. Select **"Wheat Shorts"** from the **Add Selected Ingredient to Diet** list, highlight, and click **OK**. Enter **"2%"** in **Step 3** for **Percentage in diet (%DM)**.
6. Add the remaining ingredients to the diet as follows: "Corn distiller's dried grains" (10.6%); "Soybean meal, fermented" (8.15%), "Canola, Full fat" (1%), "Field peas" (5.0%), "Canola Meal, Expelled" (15%), and "Barley" (20%).
7. If any ingredient is not found in the **Full Text Search**, the user can enter the ingredient information independently using the **Create Custom Ingredient** button. In this example, we will add the combination of lysine/vitamins (0.25%) as a custom ingredient. Holos will now report the diet as being complete when all ingredients total 100%.
8. Under **Step 1** input **"3"** as the value for the feed intake.
9. Click the **OK** button to save the new custom diet.
10. Now on the **Diet** tab, **"Custom Boar Diet"** can be selected from the drop down-down menu as the new diet for this animal group.

11. On the **Housing** tab select **"Housed in Barn"** with **"Straw (Chopped)"** bedding (keep the default application rate), and on the **Manure** tab select **"Liquid/Slurry with natural crust"**. 
 <br>
...
4. On the **Diet Tab**, as these animals are exclusively milk-fed, select **"None"** from the diet drop down menu. On the **Housing Tab** select **"Housed in Barn"** and set the bedding type as **"Straw (Chopped)"** (keep the default application rate). On the **Manure Tab** select **"Liquid/Slurry with natural crust"**.
...
6. For the second, and third management periods, the hogs will be placed on pasture - rename these management periods **"Summer Pasture Hogs 1"** and **"Summer Pasture Hogs 2"**. Set the start date for **"Summer Pasture Hogs 1"** to **"June 20, 2024"** and the end date to **"July 6, 2024"** (17 days), and set the start and end dates for **"Summer Pasture Hogs 2"** to **"July 7, 2024"** and **"August 2, 2024"**, respectively (27 days). 
...
9. In **Step 2** and **Step 3**, add the diet ingredients as follows: **"Barley"** (99.5%) and **"Lysine/vitamins"** (0.5%). **"Lysine/vitamins"** will now appear in the text search as it was previously added for the **"Custom Boar Diet"**. 

10. Under **Step 1** enter **"3"** as the feed intake for the **"Hog Supplement"** diet. Click **OK** to save.

11. For the **"Summer Pasture Hogs 1"** and **"Summer Pasture Hogs 2"**, on the **Diet tab** select **"Hog Supplement"** from the drop down menu. On the **Housing** tab, select **"Pasture/range/paddock"** as the housing type and select **"Native Grassland"** as the pasture location, and on the **Manure** tab, select **"Pasture/range/paddock** as the manure handling system.

12. For the final management period, set the start and end dates to **"August 3, 2024"** and **"September 16, 2024"**, respectively (45 days).

13. Highlight this management period, and on the **General** tab leave **"Growing/finishing"** as the production stage and enter **"1000"** as the number of animals.

14. On the **Diet** tab, select **"Grower/Finisher diet #4"** as the diet type. On the **Housing** tab, select **"Housed in barn"** as the housing type and leave **"Straw (Chopped)"** as the bedding type (keep the default application rate, and on the **Manure** tab, select **"Liquid/Slurry with natural crust"** as the manure handling system.
...
2. Click on the **Manure tab** and then click the **Add Manure Application** button. 
    ...
    * Enter **"200 kg ha<sup>-1</sup>"** as the amount of manure applied to this field.
